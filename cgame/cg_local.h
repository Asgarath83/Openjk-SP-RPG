...
// CALORE, MAGMA, FUOCO VAMPIRICO, FUOCO INFERNALE, FUOCO HYLDEN 
...
// FONT OF PUTRESCESCENSE HELLISH FOR DEMONS
...
// FANGO BRUNO (ABOMINI DELLE CAVERNE)
...
// ACID 
void FX_AcidProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// GREEN CRYSTAL 
void FX_GcrystalProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// TELEKINESIS SEARCH PROJECTILES OF TUREL  
...
// NECROMANTIC FIRE 
void FX_BlackFireProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECROMANTIC ALTFIRE: IMMOLATION 
void FX_ImmolationProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECROMANTIC HOLY IMMOLATION // ATTENDENTE DEL SACRO  
void FX_HolyImmolationProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECROMANTIC SPIRITH DEATH 
void FX_SDProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECRO MIND // ATTENDENTE DELLA NEBBIA  
void FX_MindProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECRO DIMENSION // ATTENDENTE DELLA FORGIA ASTRALE 
void FX_DimProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECRO CONFLICT // ATTENDENTE DEL MAGMA 
void FX_ConflictProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECRO NATURE // ATTENDENTE DELLA NATURA E ATTENDENTE DELLA VITA 
void FX_NatureProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// ATTENDENTE DEL FULMINE 
void FX_ElectroProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// ATTENDENTE DELL'ENERGIA  
void FX_EnergyProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// ATTENDENTE DEL VELENO 
void FX_NecroPoisonProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECRO TIME // ATTENDENTE DELLA SABBIA - TEMPESTA 
void FX_TimeProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// ATTENDENTE DEGLI STATI - STONE 
void FX_RockProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECRO CHAOS
void FX_ChaosProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECRO DEATH 
void FX_NecroProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECRO VOID - ATTENDENTE DEL VUOTO 
void FX_NecrovoidProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECRO SMOG - ATTENDENTE DEL FUMO 
void FX_NecrosmogProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECRO MUD
void FX_NecromudProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// NECRO CRYSTAL 
void FX_NecroCrystalProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// FORCE
void FX_Tusken2ShotProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// STONE
void FX_Tusken3ShotProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// SONIC
void FX_Tusken4ShotProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// WATER 
void FX_Tusken5ShotProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// SUN
void FX_Tusken6ShotProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// HOLY 
void FX_Tusken7ShotProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// VAMPIRES  
void FX_Tusken8ShotProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// UNDEADS 
void FX_Tusken0ShotProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// HYLDEN 
void FX_Tusken9ShotProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// DARK SHOOTS
void FX_Tusken1ShotProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// POISON SHOOTS 
void FX_Tusken10ShotProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
/* ALTRI EFX: 
- TRIPMINE: SONICHE \ EVIL PLANTS 
- DETPACK: QUAKE BOMB \ RAZIELHIM BOMB 
- THERMAL: SMOKING \ FLASH \ FRAG \ CRYO \ FIRE \ ACID \ SHOCK \ SONIC \ LAVA \ HOLY
*/
/////////////////////////////////
//ALL STARSHIP SHOOTS EFFECTS 
// Stunner
...
// LASERS 
void FX_GreenLaserProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
void FX_GreenLaserAltFireThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// SHRAPNEL
void FX_ShrapnelProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
...
// ANTIMATTER  
void FX_AMProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon );
