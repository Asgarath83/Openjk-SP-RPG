...
void CG_EntityEvent( centity_t *cent, vec3_t position ) {
	...
	case EV_CHANGE_WEAPON:
		...
		{
			if ( cent->gent->client && cent->gent->client->gs.gun->Gun_Select_Sound )
			{
				// custom select sound
	...
	case EV_BLACKFIRE_ALT_MISS:
		DEBUGNAME("EV_BLACKFIRE_ALT_MISS");
		FX_BlackFireAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

	case EV_SONIC_ALT_MISS:
		DEBUGNAME("EV_SONIC_ALT_MISS");
		FX_BlackFireAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_IMMOLATION_ALT_MISS:
		DEBUGNAME("EV_IMMOLATION_ALT_MISS");
		FX_ImmolationAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_HOLYIMMOLATION_ALT_MISS:
		DEBUGNAME("EV_HOLYIMMOLATION_ALT_MISS");
		FX_HolyImmolationAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_SD_ALT_MISS:
		DEBUGNAME("EV_SD_ALT_MISS");
		FX_SDAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;
		
		case EV_MIND_ALT_MISS:
		DEBUGNAME("EV_MIND_ALT_MISS");
		FX_MindAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_DIM_ALT_MISS:
		DEBUGNAME("EV_DIM_ALT_MISS");
		FX_DimAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_CONFLICT_ALT_MISS:
		DEBUGNAME("EV_CONFLICT_ALT_MISS");
		FX_ConflictAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_NECRO_ALT_MISS:
		DEBUGNAME("EV_NECRO_ALT_MISS");
		FX_NecroAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_NATURE_ALT_MISS:
		DEBUGNAME("EV_NATURE_ALT_MISS");
		FX_NatureAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_ENERGY_ALT_MISS:
		DEBUGNAME("EV_ENERGY_ALT_MISS");
		FX_EnergyAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_ELECTRO_ALT_MISS:
		DEBUGNAME("EV_ELECTRO_ALT_MISS");
		FX_ElectroAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_TIME_ALT_MISS:
		DEBUGNAME("EV_TIME_ALT_MISS");
		FX_TimeAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_ROCK_ALT_MISS:
		DEBUGNAME("EV_ROCK_ALT_MISS");
		FX_RockAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_CHAOS_ALT_MISS:
		DEBUGNAME("EV_CHAOS_ALT_MISS");
		FX_ChaosAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_NECROPOISON_ALT_MISS:
		DEBUGNAME("EV_NECROPOISON_ALT_MISS");
		FX_NecroPoisonAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_NECROSMOG_ALT_MISS:
		DEBUGNAME("EV_NECROSMOG_ALT_MISS");
		FX_NecrosmogAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_NECROVOID_ALT_MISS:
		DEBUGNAME("EV_NECROVOID_ALT_MISS");
		FX_NecrovoidAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_NECROMUD_ALT_MISS:
		DEBUGNAME("EV_NECROMUD_ALT_MISS");
		FX_NecromudAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;

		case EV_NECROCRYSTAL_ALT_MISS:
		DEBUGNAME("EV_NECROCRYSTAL_ALT_MISS");
		FX_NecroCrystalAltMiss( cent->lerpOrigin, cent->gent->pos1 );
		break;
