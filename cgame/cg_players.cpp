...
void CG_ForcePushBlur( const vec3_t org, qboolean darkSide )
{
	...
	if ( darkSide )
	{// Tk Grip of Kain is red
		ex->color[0] = 16;
		ex->color[1] = 100;
		ex->color[2] = 40;
	}
	else
	{// Push and Pull of Reavers
		ex->color[0] = 10;
		ex->color[1] = 10;
		ex->color[2] = 10;
	}
...
void CG_AddForceSightShell( refEntity_t *ent, centity_t *cent )
{
	...
	//{TEST: level 3 identifies friend or foe with color
		...
		case TEAM_ENEMY:
			...
			{ // HUMAN AURA IS AZURE
				 // HUMANS
				if ( cent->gent->client->NPC_class == CLASS_PRISONER
					|| cent->gent->client->NPC_class == CLASS_RODIAN
					|| cent->gent->client->NPC_class == CLASS_JAN
					|| cent->gent->client->NPC_class == CLASS_LANDO
					|| cent->gent->client->NPC_class == CLASS_GALAK
					|| cent->gent->client->NPC_class == CLASS_STORMTROOPER
					|| cent->gent->client->NPC_class == CLASS_IMPWORKER
					|| cent->gent->client->NPC_class == CLASS_WIZARD
					|| cent->gent->client->NPC_class == CLASS_CENOBITA 
					|| cent->gent->client->NPC_class == CLASS_IMPERIAL
					|| cent->gent->client->NPC_class == CLASS_WARRIOR
					|| cent->gent->client->NPC_class == CLASS_DRUID
					|| cent->gent->client->NPC_class == CLASS_CENOBITA 
					|| cent->gent->client->NPC_class == CLASS_HUNTER
					|| cent->gent->client->NPC_class == CLASS_SCOUT
					|| cent->gent->client->NPC_class == CLASS_ALCHEMIST	)
				{
					ent->shaderRGBA[0] = 142;
					ent->shaderRGBA[1] = 249;
					ent->shaderRGBA[2] = 208;
				} // ARTIFACT AURA IS GREY
				else if  ( cent->gent->client->NPC_class == CLASS_SEEKER
					|| cent->gent->client->NPC_class == CLASS_REMOTE
					|| cent->gent->client->NPC_class == CLASS_SENTRY
					|| cent->gent->client->NPC_class == CLASS_MARK1
					|| cent->gent->client->NPC_class == CLASS_MARK2	
					|| cent->gent->client->NPC_class == CLASS_GOLEM
					|| cent->gent->client->NPC_class == CLASS_GOLEM_DARK
					|| cent->gent->client->NPC_class == CLASS_GOLEM_SMOKE
					|| cent->gent->client->NPC_class == CLASS_GOLEM_VOID
					|| cent->gent->client->NPC_class == CLASS_GOLEM_LIGHT	
					|| cent->gent->client->NPC_class == CLASS_GOLEM_GOLD
					|| cent->gent->client->NPC_class == CLASS_GOLEM_METAL
					|| cent->gent->client->NPC_class == CLASS_GOLEM_FIRE
					|| cent->gent->client->NPC_class == CLASS_GOLEM_LAVA
					|| cent->gent->client->NPC_class == CLASS_HELLGOLEM	
					|| cent->gent->client->NPC_class == CLASS_GOLEM_AIR
					|| cent->gent->client->NPC_class == CLASS_GOLEM_WATER
					|| cent->gent->client->NPC_class == CLASS_GOLEM_ICE
					|| cent->gent->client->NPC_class == CLASS_GOLEM_SONIC
					|| cent->gent->client->NPC_class == CLASS_GOLEM_POISON	
					|| cent->gent->client->NPC_class == CLASS_GOLEM_HOLY
					|| cent->gent->client->NPC_class == CLASS_GOLEM_NECRO )
				{
					ent->shaderRGBA[0] = 120;
					ent->shaderRGBA[1] = 120;
					ent->shaderRGBA[2] = 120;
				} 
				 //DARKNESS
				else if  ( cent->gent->client->NPC_class == CLASS_SHADOWTROOPER
					|| cent->gent->client->NPC_class == CLASS_SABOTEUR 
					|| cent->gent->client->NPC_class == CLASS_BESPIN_COP
					|| cent->gent->client->NPC_class == CLASS_DARK
					|| cent->gent->client->NPC_class == CLASS_VOID	)					 
				{
					ent->shaderRGBA[0] = 36;
					ent->shaderRGBA[1] = 50;
					ent->shaderRGBA[2] = 102;
				}
				//LIGHT
					...
					|| cent->gent->client->NPC_class == CLASS_MORGANKATARN 
					|| cent->gent->client->NPC_class == CLASS_LIGHT 
					)
				{
					ent->shaderRGBA[0] = 227;
					ent->shaderRGBA[1] = 246;
					ent->shaderRGBA[2] = 38;
				}// MAGMA
				else if  ( cent->gent->client->NPC_class == CLASS_HAZARD_TROOPER
					|| cent->gent->client->NPC_class == CLASS_FIRE  
					)
				{
					ent->shaderRGBA[0] = 246;
					ent->shaderRGBA[1] = 96;
					ent->shaderRGBA[2] = 38;
				}// WIND
				else if  ( cent->gent->client->NPC_class == CLASS_PROBE
					|| cent->gent->client->NPC_class == CLASS_ROCKETTROOPER	
					|| cent->gent->client->NPC_class == CLASS_REBEL	
					|| cent->gent->client->NPC_class == CLASS_AIR	
					)
				{
					ent->shaderRGBA[0] = 249;
					ent->shaderRGBA[1] = 241;
					ent->shaderRGBA[2] = 237;
				}// ICE 
				else if  ( cent->gent->client->NPC_class == CLASS_BARTENDER
					|| cent->gent->client->NPC_class == CLASS_SWAMP
					|| cent->gent->client->NPC_class == CLASS_GALAKMECH	
					|| cent->gent->client->NPC_class == CLASS_WATER	
					|| cent->gent->client->NPC_class == CLASS_CRYSTAL )
				{
					ent->shaderRGBA[0] = 45;
					ent->shaderRGBA[1] = 166;
					ent->shaderRGBA[2] = 209;
				}
				// EARTH
				else if  ( cent->gent->client->NPC_class == CLASS_GONK 
					|| cent->gent->client->NPC_class == CLASS_EARTH )
				{
					ent->shaderRGBA[0] = 72;
					ent->shaderRGBA[1] = 146;
					ent->shaderRGBA[2] = 105;
				}// SONIC
				else if  ( cent->gent->client->NPC_class == CLASS_HOWLER ||
					cent->gent->client->NPC_class == CLASS_SONIC )
				{
					ent->shaderRGBA[0] = 202;
					ent->shaderRGBA[1] = 99;
					ent->shaderRGBA[2] = 215;
				} 
				// VAMPIRES
				else if  ( cent->gent->client->NPC_class == CLASS_TUSKEN
					|| cent->gent->client->NPC_class == CLASS_GLIDER
					|| cent->gent->client->NPC_class == CLASS_NOGHRI
					|| cent->gent->client->NPC_class == CLASS_FLIER2
					|| cent->gent->client->NPC_class == CLASS_WEEQUAY
					|| cent->gent->client->NPC_class == CLASS_LIZARD
					|| cent->gent->client->NPC_class == CLASS_SWAMPTROOPER
					|| cent->gent->client->NPC_class == CLASS_GLIDER
					|| cent->gent->client->NPC_class == CLASS_FISH
					|| cent->gent->client->NPC_class == CLASS_GRAN
					|| cent->gent->client->NPC_class == CLASS_CLAW	
					|| cent->gent->client->NPC_class == CLASS_MELC
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_ZOMBIE 
					|| cent->gent->client->NPC_class == CLASS_SUMMONER
					|| cent->gent->client->NPC_class == CLASS_ZEPH
					|| cent->gent->client->NPC_class == CLASS_DECEIVER
					|| cent->gent->client->NPC_class == CLASS_DUMAHIM
					|| cent->gent->client->NPC_class == CLASS_RAHABIM
					|| cent->gent->client->NPC_class == CLASS_TURELIM 
					|| cent->gent->client->NPC_class == CLASS_RAZIELHIM
					|| cent->gent->client->NPC_class == CLASS_ESKANDOR )
				{
					ent->shaderRGBA[0] = 255;
					ent->shaderRGBA[1] = 0;
					ent->shaderRGBA[2] = 0;
				}// ANCIENT VAMPIRES E ALLIANCE VAMPIRES 
				else if  ( cent->gent->client->NPC_class == CLASS_REBORN
					|| cent->gent->client->NPC_class == CLASS_KYLE	
					|| cent->gent->client->NPC_class == CLASS_KAIN	
					|| cent->gent->client->NPC_class == CLASS_KAIN2
					|| cent->gent->client->NPC_class == CLASS_KAIN3
					|| cent->gent->client->NPC_class == CLASS_UMAH 
					|| cent->gent->client->NPC_class == CLASS_JANOS
					|| cent->gent->client->NPC_class == CLASS_VORADOR
					|| cent->gent->client->NPC_class == CLASS_NECROMANCER
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_QUEEN
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_DARK
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_FROST
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_ARCHER
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_FEAR
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_FEAR2
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_BOUNTY
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_SOUND
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_BLOOD
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_LYCAN
					|| cent->gent->client->NPC_class == CLASS_HALFVAMPIRE
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_NECRO
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_NECRO2
					|| cent->gent->client->NPC_class == CLASS_WOLFKAIN	
					|| cent->gent->client->NPC_class == CLASS_WOLFKAIN2
					|| cent->gent->client->NPC_class == CLASS_WOLFKAIN3
					|| cent->gent->client->NPC_class == CLASS_WOLFJANOS
					|| cent->gent->client->NPC_class == CLASS_WOLFVORADOR
					|| cent->gent->client->NPC_class == CLASS_WOLFNECROMANCER
					|| cent->gent->client->NPC_class == CLASS_WOLFVAMPIRE_QUEEN
					|| cent->gent->client->NPC_class == CLASS_WOLFVAMPIRE_FEAR
					|| cent->gent->client->NPC_class == CLASS_WOLFVAMPIRE_FEAR2
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_BOUNTY
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_SOUND
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_BLOOD
					|| cent->gent->client->NPC_class == CLASS_WOLFVAMPIRE_LYCAN
					|| cent->gent->client->NPC_class == CLASS_WOLFFORM
					|| cent->gent->client->NPC_class == CLASS_BATKAIN	
					|| cent->gent->client->NPC_class == CLASS_BATKAIN2
					|| cent->gent->client->NPC_class == CLASS_BATKAIN3
					|| cent->gent->client->NPC_class == CLASS_BATVORADOR
					|| cent->gent->client->NPC_class == CLASS_BATNECROMANCER
					|| cent->gent->client->NPC_class == CLASS_BATVAMPIRE_QUEEN
					|| cent->gent->client->NPC_class == CLASS_BATVAMPIRE_FROST
					|| cent->gent->client->NPC_class == CLASS_BATVAMPIRE_FEAR
					|| cent->gent->client->NPC_class == CLASS_BATVAMPIRE_FEAR2
					|| cent->gent->client->NPC_class == CLASS_MISTKAIN	
					|| cent->gent->client->NPC_class == CLASS_MISTKAIN2
					|| cent->gent->client->NPC_class == CLASS_MISTKAIN3
					|| cent->gent->client->NPC_class == CLASS_MISTJANOS
					|| cent->gent->client->NPC_class == CLASS_MISTVORADOR
					|| cent->gent->client->NPC_class == CLASS_MISTNECROMANCER
					|| cent->gent->client->NPC_class == CLASS_MISTVAMPIRE_QUEEN
					|| cent->gent->client->NPC_class == CLASS_MISTVAMPIRE_DARK
					|| cent->gent->client->NPC_class == CLASS_MISTVAMPIRE_FEAR
					|| cent->gent->client->NPC_class == CLASS_MISTVAMPIRE_FEAR2
					|| cent->gent->client->NPC_class == CLASS_MISTVAMPIRE_BLOOD
					|| cent->gent->client->NPC_class == CLASS_MISTVAMPIRE_SARAFAN
					|| cent->gent->client->NPC_class == CLASS_BATFORM
					|| cent->gent->client->NPC_class == CLASS_WOLFFORM
					|| cent->gent->client->NPC_class == CLASS_MISTFORM
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE )
				{
					ent->shaderRGBA[0] = 208;
					ent->shaderRGBA[1] = 55;
					ent->shaderRGBA[2] = 53;
				} 
				// RAHABIM VAMPIRE 
				else if ( cent->gent->client->NPC_class == CLASS_ALORA ||
					cent->gent->client->NPC_class == CLASS_VAMPIRE_WATER ||
					cent->gent->client->NPC_class == CLASS_BATVAMPIRE_WATER ||
					cent->gent->client->NPC_class == CLASS_MISTVAMPIRE_WATER )
				{
					ent->shaderRGBA[0] = 205;
					ent->shaderRGBA[1] = 200;
					ent->shaderRGBA[2] = 0;
				}
				// ELF VAMPIRE 
				else if  ( cent->gent->client->NPC_class == CLASS_MONMOTHA ||
					cent->gent->client->NPC_class == CLASS_VAMPIRE_ELF ||
					cent->gent->client->NPC_class == CLASS_VAMPIRE_ELF2 ||
					cent->gent->client->NPC_class == CLASS_VAMPIRE_ELF3 ||
					cent->gent->client->NPC_class == CLASS_WOLFVAMPIRE_ELF ||
					cent->gent->client->NPC_class == CLASS_LIONVAMPIRE_ELF ||
					cent->gent->client->NPC_class == CLASS_LIONVAMPIRE_ELF2 ||
					cent->gent->client->NPC_class == CLASS_BATVAMPIRE_ELF ||
					cent->gent->client->NPC_class == CLASS_BATVAMPIRE_ELF2 ||
					cent->gent->client->NPC_class == CLASS_BATVAMPIRE_ELF3 )
				{
					ent->shaderRGBA[0] = 208;
					ent->shaderRGBA[1] = 106;
					ent->shaderRGBA[2] = 206;
				} // GHOSTS
				else if ( cent->gent->client->NPC_class == CLASS_MOUSE
					|| cent->gent->client->NPC_class == CLASS_JAWA 
					|| cent->gent->client->NPC_class == CLASS_PROBE
					|| cent->gent->client->NPC_class == CLASS_POLTER	
					|| cent->gent->client->NPC_class == CLASS_RANCOR	
					|| cent->gent->client->NPC_class == CLASS_SLUAGH 
					|| cent->gent->client->NPC_class == CLASS_GHOST
					|| cent->gent->client->NPC_class == CLASS_REAPER
					|| cent->gent->client->NPC_class == CLASS_ARIEL 
					|| cent->gent->client->NPC_class == CLASS_DREADNOUGHT 
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_GHOST
					|| cent->gent->client->NPC_class == CLASS_JAWA 
					|| cent->gent->client->NPC_class == CLASS_PROBE
					|| cent->gent->client->NPC_class == CLASS_RANCOR 	)
				{
					...
					|| cent->gent->client->NPC_class == CLASS_REAVER
					|| cent->gent->client->NPC_class == CLASS_NECROREAVER
					|| cent->gent->client->NPC_class == CLASS_TANKREAVER
					|| cent->gent->client->NPC_class == CLASS_DARKREAVER
					|| cent->gent->client->NPC_class == CLASS_LIGHTREAVER
					|| cent->gent->client->NPC_class == CLASS_FIREREAVER
					|| cent->gent->client->NPC_class == CLASS_AIRREAVER
					|| cent->gent->client->NPC_class == CLASS_ICEREAVER
					|| cent->gent->client->NPC_class == CLASS_EARTHREAVER
					|| cent->gent->client->NPC_class == CLASS_MENTALIST
					|| cent->gent->client->NPC_class == CLASS_DRUIDREAVER
					|| cent->gent->client->NPC_class == CLASS_HOLY
					|| cent->gent->client->NPC_class == CLASS_NECROREAVER
					|| cent->gent->client->NPC_class == CLASS_SPIDERREAVER
					|| cent->gent->client->NPC_class == CLASS_SPIDERREAVER2
					|| cent->gent->client->NPC_class == CLASS_SPIDERREAVER3	)
				{
					ent->shaderRGBA[0] = 240;
					ent->shaderRGBA[1] = 240;
					ent->shaderRGBA[2] = 255;
				}//UNDEADS
				else if ( cent->gent->client->NPC_class == CLASS_COMMANDO
					|| cent->gent->client->NPC_class == CLASS_MURJJ
					|| cent->gent->client->NPC_class == CLASS_THRALL
					|| cent->gent->client->NPC_class == CLASS_NECRO 
					|| cent->gent->client->NPC_class == CLASS_PROPHET )
				{
					ent->shaderRGBA[0] = 20;
					ent->shaderRGBA[1] = 0;
					ent->shaderRGBA[2] = 50;
					...
					|| cent->gent->client->NPC_class == CLASS_MINEMONSTER 
					|| cent->gent->client->NPC_class == CLASS_DEMON_POISON
					|| cent->gent->client->NPC_class == CLASS_DEMON_FIRE
					|| cent->gent->client->NPC_class == CLASS_DEMON_BLADE
					|| cent->gent->client->NPC_class == CLASS_DEMON_ELECTRO	
					|| cent->gent->client->NPC_class == CLASS_HELLBAT
					|| cent->gent->client->NPC_class == CLASS_HELLWOLF
					|| cent->gent->client->NPC_class == CLASS_HELLMIST
					|| cent->gent->client->NPC_class == CLASS_VAMPIRE_DEMON	)
				{
					ent->shaderRGBA[0] = 255;
					ent->shaderRGBA[1] = 43;
					ent->shaderRGBA[2] = 0;
					...
					|| cent->gent->client->NPC_class == CLASS_TRANDOSHAN
					|| cent->gent->client->NPC_class == CLASS_LYCAN 
					|| cent->gent->client->NPC_class == CLASS_IVY	
					|| cent->gent->client->NPC_class == CLASS_POISON
					|| cent->gent->client->NPC_class == CLASS_BEAST 
					|| cent->gent->client->NPC_class == CLASS_BIRD
					|| cent->gent->client->NPC_class == CLASS_SHARK )
				{
					ent->shaderRGBA[0] = 255;
					...
					|| cent->gent->client->NPC_class == CLASS_DESANN
					|| cent->gent->client->NPC_class == CLASS_REELO 
					|| cent->gent->client->NPC_class == CLASS_UGNAUGHT 
					|| cent->gent->client->NPC_class == CLASS_HYLDEN 
					|| cent->gent->client->NPC_class == CLASS_HYLDENLORD )
				{
					ent->shaderRGBA[0] = 0;
					ent->shaderRGBA[1] = 255;
					ent->shaderRGBA[2] = 156;
				}//ELDER GOD 
					else if ( cent->gent->client->NPC_class == CLASS_ATST
					|| cent->gent->client->NPC_class == CLASS_SAND_CREATURE	
					|| cent->gent->client->NPC_class == CLASS_ELDERGOD
					|| cent->gent->client->NPC_class == CLASS_TENTACLE	)
				{
					ent->shaderRGBA[0] = 10;
					ent->shaderRGBA[1] = 10;
					ent->shaderRGBA[2] = 10;
			...
			break;
		case TEAM_PLAYER: // ALLIED AURA COLOR 
			//ent->shaderRGBA[0] = 0;
			//ent->shaderRGBA[1] = 255;
			//ent->shaderRGBA[2] = 0;
			if ( cent->gent && cent->gent->client )
			{    // HUMANS
					...
					cent->gent->client->NPC_class == CLASS_MISTVAMPIRE_WATER )
				{
					...
					cent->gent->client->NPC_class == CLASS_BATVAMPIRE_ELF3 )
				{
					ent->shaderRGBA[0] = 218;
					ent->shaderRGBA[1] = 156;
					ent->shaderRGBA[2] = 226;
				} // GHOSTS
				else if ( cent->gent->client->NPC_class == CLASS_MOUSE
					|| cent->gent->client->NPC_class == CLASS_JAWA 
					|| cent->gent->client->NPC_class == CLASS_PROBE
...
*/
	...
	{ //protect is represented by green..
		// Vampires 
		if ( cent->gent->client->NPC_class == CLASS_REBORN
			|| cent->gent->client->NPC_class == CLASS_ALORA
			|| cent->gent->client->NPC_class == CLASS_KYLE
			|| cent->gent->client->NPC_class == CLASS_TUSKEN
			|| cent->gent->client->NPC_class == CLASS_GLIDER
			|| cent->gent->client->NPC_class == CLASS_NOGHRI
			|| cent->gent->client->NPC_class == CLASS_FLIER2
			|| cent->gent->client->NPC_class == CLASS_WEEQUAY
			...
			|| cent->gent->client->NPC_class == CLASS_VAMPIRE_LYCAN
			|| cent->gent->client->NPC_class == CLASS_VAMPIRE_SOUND
			|| cent->gent->client->NPC_class == CLASS_VAMPIRE_SARAFAN	
			|| cent->gent->client->NPC_class == CLASS_VAMPIRE_BOUNTY 
			|| cent->gent->client->NPC_class == CLASS_VAMPIRE_NECRO	
			|| cent->gent->client->NPC_class == CLASS_VAMPIRE_NECRO2
			|| cent->gent->client->NPC_class == CLASS_VAMPIRE_ZOMBIE	
		...
		{
			ent->shaderRGBA[0] = 89; //add any number from 0-255 to use your own color
			ent->shaderRGBA[1] = 147; //add any number from 0-255 to use your own color
			ent->shaderRGBA[2] = 237; //add any number from 0-255 to use your own color
		}
		// Reapers and Ghosts 
		else if ( cent->gent->client->NPC_class == CLASS_JEDI
			|| cent->gent->client->NPC_class == CLASS_LUKE
			...
			|| cent->gent->client->NPC_class == CLASS_REAVER
			|| cent->gent->client->NPC_class == CLASS_MENTALIST			
			|| cent->gent->client->NPC_class == CLASS_RAZIEL
			|| cent->gent->client->NPC_class == CLASS_TANKREAVER
			|| cent->gent->client->NPC_class == CLASS_DARKREAVER
			|| cent->gent->client->NPC_class == CLASS_NECROREAVER			
			|| cent->gent->client->NPC_class == CLASS_LIGHTREAVER
			...
			|| cent->gent->client->NPC_class == CLASS_DRUIDREAVER
			|| cent->gent->client->NPC_class == CLASS_EARTHREAVER 
			|| cent->gent->client->NPC_class == CLASS_MOUSE
			|| cent->gent->client->NPC_class == CLASS_JAWA
			|| cent->gent->client->NPC_class == CLASS_PROBE
			|| cent->gent->client->NPC_class == CLASS_LANDO
			|| cent->gent->client->NPC_class == CLASS_HOLY	
		...
		// Demons
			...
			|| cent->gent->client->NPC_class == CLASS_HELLGOLEM	)
		{
			ent->shaderRGBA[0] = 229;   //add any number from 0-255 to use your own color
			ent->shaderRGBA[1] = 47; //add any number from 0-255 to use your own color
			ent->shaderRGBA[2] = 33;   //add any number from 0-255 to use your own color
		}
		// Hylden
		else if ( cent->gent->client->NPC_class == CLASS_TAVION
			|| cent->gent->client->NPC_class == CLASS_HYLDEN 
		...
		{
			ent->shaderRGBA[0] = 229;   //add any number from 0-255 to use your own color
			ent->shaderRGBA[1] = 247; //add any number from 0-255 to use your own color
			ent->shaderRGBA[2] = 88;   //add any number from 0-255 to use your own color
		}
		// The Elder God
		else if ( cent->gent->client->NPC_class == CLASS_ATST
			|| cent->gent->client->NPC_class == CLASS_SAND_CREATURE 
			...
			|| cent->gent->client->NPC_class == CLASS_TENTACLE ) 
		{
			...
			ent->shaderRGBA[1] = 55; //add any number from 0-255 to use your own color
			ent->shaderRGBA[2] = 0;   //add any number from 0-255 to use your own color
		}
		// Human and Mortal Creatures
			...
			|| cent->gent->client->NPC_class == CLASS_LYCAN
			|| cent->gent->client->NPC_class == CLASS_HUNTER
			|| cent->gent->client->NPC_class == CLASS_ARCHER 
			|| cent->gent->client->NPC_class == CLASS_ALCHEMIST 
			|| cent->gent->client->NPC_class == CLASS_SCOUT
			|| cent->gent->client->NPC_class == CLASS_SARAFAN 
			|| cent->gent->client->NPC_class == CLASS_WARRIOR 
			|| cent->gent->client->NPC_class == CLASS_GOLEM_POISON )
		{
			ent->shaderRGBA[0] = 69;
			ent->shaderRGBA[1] = 197;
			ent->shaderRGBA[2] = 128;
			ent->customShader = cgs.media.runeShell;
		}
		// Artifacts 
		...
		{
			if ( cent->gent->client->ps.forcePowerLevel[FP_PROTECT] > FORCE_LEVEL_2 )
			{
				ent->shaderRGBA[0] = 0;
				ent->shaderRGBA[1] = 0;
				ent->shaderRGBA[2] = 255;
	...
	//	Not sure about that 
			...
			|| cent->gent->client->NPC_class == CLASS_HALFVAMPIRE )
		{
			ent->shaderRGBA[0] = 221; //add any number from 0-255 to use your own color
			ent->shaderRGBA[1] = 22; //add any number from 0-255 to use your own color
			ent->shaderRGBA[2] = 239; //add any number from 0-255 to use your own color
		}
		// Reapers and Ghosts 
		else if ( cent->gent->client->NPC_class == CLASS_JEDI
			|| cent->gent->client->NPC_class == CLASS_LUKE
			...
			|| cent->gent->client->NPC_class == CLASS_GOLEM_HOLY )
		{
			ent->shaderRGBA[0] = 29; //add any number from 0-255 to use your own color
			ent->shaderRGBA[1] = 232;  //add any number from 0-255 to use your own color
			ent->shaderRGBA[2] = 239;  //add any number from 0-255 to use your own color
		}
		// Demons
		else if ( cent->gent->client->NPC_class == CLASS_MINEMONSTER 
			...
			|| cent->gent->client->NPC_class == CLASS_DEMON_ELECTRO )
		{
			ent->shaderRGBA[0] = 146;   //add any number from 0-255 to use your own color
			ent->shaderRGBA[1] = 36; //add any number from 0-255 to use your own color
			ent->shaderRGBA[2] = 34;   //add any number from 0-255 to use your own color
		}
		// Hylden
		else if ( cent->gent->client->NPC_class == CLASS_TAVION
			|| cent->gent->client->NPC_class == CLASS_HYLDEN 
			...
			|| cent->gent->client->NPC_class == CLASS_DESANN )
		{
			ent->shaderRGBA[0] = 44;   //add any number from 0-255 to use your own color
			ent->shaderRGBA[1] = 207; //add any number from 0-255 to use your own color
			ent->shaderRGBA[2] = 117;   //add any number from 0-255 to use your own color
		}
		// The Elder God
		else if ( cent->gent->client->NPC_class == CLASS_ATST
			|| cent->gent->client->NPC_class == CLASS_SAND_CREATURE 
			...
			|| cent->gent->client->NPC_class == CLASS_TENTACLE ) 
		{
			...
			ent->shaderRGBA[1] = 0; //add any number from 0-255 to use your own color
			ent->shaderRGBA[2] = 0;   //add any number from 0-255 to use your own color
		}
		// Human and Mortal Creatures
		else if ( cent->gent->client->NPC_class == CLASS_PRISONER
			...
			|| cent->gent->client->NPC_class == CLASS_WARRIOR )
		{
			ent->shaderRGBA[0] = 172;
			ent->shaderRGBA[1] = 248;
			ent->shaderRGBA[2] = 254;
			ent->customShader = cgs.media.runeShell;
		}
		// Artifacts 
		else if ( cent->gent->client->NPC_class == CLASS_R2D2
	...
	/*if // Wolf, bat and mist form cannot have this rgba shield or color! same the vampires!) 
	( cent->gent->client->NPC_class == CLASS_KAIN ||
	cent->gent->client->NPC_class == CLASS_KAIN2 ||
	cent->gent->client->NPC_class == CLASS_KAIN3 ||
	cent->gent->client->NPC_class == CLASS_UMAH ||
	...
	cent->gent->client->NPC_class == CLASS_LIONVAMPIRE_ELF ||
	cent->gent->client->NPC_class == CLASS_LIONVAMPIRE_ELF2 ||
	cent->gent->client->NPC_class == CLASS_WOLFHALFVAMPIRE ||
	cent->gent->client->NPC_class == CLASS_ESKANDOR ||
	cent->gent->client->NPC_class == CLASS_VAMPIRE_DEMON ||
	cent->gent->client->NPC_class == CLASS_HELLWOLF || 
	// BAT FORM 
...
static void CG_RGBForSaberColor( saber_colors_t color, vec3_t rgb )
{
	switch( color )
	{
		...
		case SABER_RED2:
			VectorSet( rgb, 0.76f, 0.18f, 0.0f );
			break;
		case SABER_WHITE:
			VectorSet( rgb, 1.0f, 1.0f, 1.0f );
			break;
		case SABER_BROWN:
			VectorSet( rgb, 0.66f, 0.41f, 0.11f );
			break;
		case SABER_GREEN2:
			VectorSet( rgb, 0.5f, 1.0f, 0.5f );
			break;
		case SABER_CYAN:
			VectorSet( rgb, 0.29f, 0.84f, 0.89f );
			break;
		case SABER_DARK:
			VectorSet( rgb, 0.08f, 0.0f, 0.15f );
			break;
		case SABER_WHITEBLUE:
			VectorSet( rgb, 0.4f, 0.6f, 1.0f );
			break;
	}
}
...
static void CG_DoSaber( vec3_t origin, vec3_t dir, float length, float lengthMax, float radius, saber_colors_t color, int rfx, qboolean doLight )
{
	...
	switch( color )
	{
		...
		// NEW SABERS
			case SABER_RED2:
			glow = cgs.media.red2SaberGlowShader;
			blade = cgs.media.red2SaberCoreShader;
			break;
		case SABER_WHITE:
			...
			break;
		case SABER_BROWN:
			glow = cgs.media.brownSaberGlowShader;
			blade = cgs.media.brownSaberCoreShader;
			break;
		case SABER_WHITEBLUE:
			glow = cgs.media.whiteblueSaberGlowShader;
			blade = cgs.media.whiteblueSaberCoreShader;
			break;
		case SABER_GREEN2:
			glow = cgs.media.green2SaberGlowShader;
			blade = cgs.media.green2SaberCoreShader;
			break;
		case SABER_DARK:
			...
			if ( saberTrail->inAction && cg.time < saberTrail->lastTime + 300 ) // if we have a stale segment, don't draw until we have a fresh one
			{
				   ...
				   )
				{
					...
					{ 
						...
						case SABER_RED2:
						VectorSet( rgb1, 193.8f, 45.9f, 0.0f );
						break;
						case SABER_WHITE:
						VectorSet( rgb1, 255.0f, 255.0f, 255.0f );
						break;
						case SABER_BROWN:
						VectorSet( rgb1, 158.3f, 104.5f, 280.9f );
						break;
						case SABER_GREEN2:
						VectorSet( rgb1, 127.5f, 255.0f, 127.5f );
						break;
						case SABER_CYAN:
						VectorSet( rgb1, 73.99f, 214.2f, 226.99f );
						break;
						case SABER_DARK:
						VectorSet( rgb1, 2.04f, 0.0f, 38.25f );
						break;
						case SABER_WHITEBLUE:
						VectorSet( rgb1, 10.2f, 15.3f, 255.0f );
...
int	cg_gunSelectSoundTime[MAX_GENTITIES] = {0};
...
extern vmCvar_t	cg_thirdPersonAlpha;
		...
		// THAT'S THE CODE FOR PLAY SOUNDS FOR WEAPON! (Loopsound?) 
...
/*			if ( cent->gent->client->ps.eFlags & EF_FORCE_DRAINED
			...
			{//doing the electrocuting
				...
				{//arc
					...
					// SPIDERWEBS 
					if ( cent->gent->client->NPC_class == CLASS_REELO || cent->gent->client->NPC_class == CLASS_SPIDERREAVER ||
						cent->gent->client->NPC_class == CLASS_SPIDERREAVER2 || cent->gent->client->NPC_class == CLASS_SPIDERREAVER3 ||
						cent->gent->client->NPC_class == CLASS_ZEPH || cent->gent->client->NPC_class == CLASS_UGNAUGHT )
						{
							G_PlayEffect( G_EffectIndex( "force/webwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
					// RIVERBERO 
					else if ( cent->gent->client->NPC_class == CLASS_MOUSE ||
						cent->gent->client->NPC_class == CLASS_JAWA || cent->gent->client->NPC_class == CLASS_NECROREAVER ||
						cent->gent->client->NPC_class == CLASS_REAPER || cent->gent->client->NPC_class == CLASS_GHOST ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_GHOST )
						{
							G_PlayEffect( G_EffectIndex( "force/ghostwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
					// ENERGY BOLT - LIGHTNING 
					else if ( cent->gent->client->NPC_class == CLASS_REBORN || cent->gent->client->NPC_class == CLASS_VAMPIRE ||
						cent->gent->client->NPC_class == CLASS_TURELIM || cent->gent->client->NPC_class == CLASS_GRAN ||
						cent->gent->client->NPC_class == CLASS_KYLE || cent->gent->client->NPC_class == CLASS_KAIN ||
						cent->gent->client->NPC_class == CLASS_ALORA || cent->gent->client->NPC_class == CLASS_MONMOTHA ||
						cent->gent->client->NPC_class == CLASS_KAIN2 || cent->gent->client->NPC_class == CLASS_KAIN3 ||
						cent->gent->client->NPC_class == CLASS_VORADOR || cent->gent->client->NPC_class == CLASS_JANOS ||
						cent->gent->client->NPC_class == CLASS_UMAH || cent->gent->client->NPC_class == CLASS_NECROMANCER ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_BOUNTY || cent->gent->client->NPC_class == CLASS_VAMPIRE_DARK ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_QUEEN || cent->gent->client->NPC_class == CLASS_VAMPIRE_WATER ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_ARCHER || cent->gent->client->NPC_class == CLASS_VAMPIRE_FROST ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_FEAR || cent->gent->client->NPC_class == CLASS_VAMPIRE_ELF ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_ELF2 || cent->gent->client->NPC_class == CLASS_VAMPIRE_ELF3 ||
						cent->gent->client->NPC_class == CLASS_HALFVAMPIRE || 
						cent->gent->client->NPC_class == CLASS_VAMPIRE_SARAFAN ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_LYCAN || cent->gent->client->NPC_class == CLASS_VAMPIRE_BLOOD )
						{
							G_PlayEffect( G_EffectIndex( "force/lightningwide2" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
					// ELETTRICITA' 
					else if ( cent->gent->client->NPC_class == CLASS_JEDI ||
						cent->gent->client->NPC_class == CLASS_REAVER ||
						cent->gent->client->NPC_class == CLASS_SEEKER || cent->gent->client->NPC_class == CLASS_REMOTE || 
						...
						cent->gent->client->NPC_class == CLASS_DEMON_ELECTRO || cent->gent->client->NPC_class == CLASS_GOLEM_METAL )
						{
							G_PlayEffect( G_EffectIndex( "force/lightningwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// TENEBRE 
					else if ( cent->gent->client->NPC_class == CLASS_SABOTEUR ||
						cent->gent->client->NPC_class == CLASS_DARK || cent->gent->client->NPC_class == CLASS_GOLEM_DARK ||
						cent->gent->client->NPC_class == CLASS_DARKREAVER )
						{
							G_PlayEffect( G_EffectIndex( "force/darkwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// FUMO 
					else if ( cent->gent->client->NPC_class == CLASS_BESPIN_COP ||  cent->gent->client->NPC_class == CLASS_TANKREAVER ||
							cent->gent->client->NPC_class == CLASS_GOLEM_SMOKE )
						{
							G_PlayEffect( G_EffectIndex( "force/smogwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// VUOTO
					else if ( cent->gent->client->NPC_class == CLASS_SHADOWTROOPER || cent->gent->client->NPC_class == CLASS_VOID ||
						cent->gent->client->NPC_class == CLASS_GOLEM_VOID )
						{
							G_PlayEffect( G_EffectIndex( "force/voidwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// FOLGORI LUCENTI 
					else if ( cent->gent->client->NPC_class == CLASS_SABER_DROID || cent->gent->client->NPC_class == CLASS_ASSASSIN_DROID || 
						cent->gent->client->NPC_class == CLASS_LIGHT || cent->gent->client->NPC_class == CLASS_LIGHTREAVER ||
						cent->gent->client->NPC_class == CLASS_GOLEM_LIGHT )
						{
							G_PlayEffect( G_EffectIndex( "force/yellowlightningwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
					// RADIANZA
					else if ( cent->gent->client->NPC_class == CLASS_MORGANKATARN || cent->gent->client->NPC_class == CLASS_PROTOCOL || 
						cent->gent->client->NPC_class == CLASS_ATST || cent->gent->client->NPC_class == CLASS_GOLEM_GOLD )
						{
							G_PlayEffect( G_EffectIndex( "force/burstwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// PALLE DI FUOCO 
					else if ( cent->gent->client->NPC_class == CLASS_RODIAN || cent->gent->client->NPC_class == CLASS_HUNTER ||
							cent->gent->client->NPC_class == CLASS_GALAK ||	cent->gent->client->NPC_class == CLASS_ARCHER || 
							cent->gent->client->NPC_class == CLASS_ALCHEMIST || cent->gent->client->NPC_class == CLASS_SCOUT ||
							cent->gent->client->NPC_class == CLASS_HELLGOLEM )
						{
							G_PlayEffect( G_EffectIndex( "force/fireballwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// FUOCO 
					else if ( cent->gent->client->NPC_class == CLASS_IMPWORKER || cent->gent->client->NPC_class == CLASS_WIZARD ||
						cent->gent->client->NPC_class == CLASS_FIRE || cent->gent->client->NPC_class == CLASS_GOLEM_FIRE )
						{
							G_PlayEffect( G_EffectIndex( "force/firewide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// CALORE - FIAMME INFERNALI 
					else if ( cent->gent->client->NPC_class == CLASS_WAMPA || cent->gent->client->NPC_class == CLASS_VAMPIRE_DEMON ||
						cent->gent->client->NPC_class == CLASS_DEMON_FIRE || cent->gent->client->NPC_class == CLASS_FIREREAVER || 
						cent->gent->client->NPC_class == CLASS_CENOBITA || cent->gent->client->NPC_class == CLASS_BOBAFETT ||
						cent->gent->client->NPC_class == CLASS_HAZARD_TROOPER || cent->gent->client->NPC_class == CLASS_IMPERIAL ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_FEAR2 )
						{
							G_PlayEffect( G_EffectIndex( "force/hellwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
					// MAGMA 
					else if ( cent->gent->client->NPC_class == CLASS_CLAW || cent->gent->client->NPC_class == CLASS_GOLEM_LAVA )
						{
							G_PlayEffect( G_EffectIndex( "force/lavawide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
					// VENTO 
					else if ( cent->gent->client->NPC_class == CLASS_PROBE || 
						cent->gent->client->NPC_class == CLASS_POLTER || 
						...
						cent->gent->client->NPC_class == CLASS_AIRREAVER )
						{
							G_PlayEffect( G_EffectIndex( "force/windwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// STORM
					else if ( cent->gent->client->NPC_class == CLASS_ROCKETTROOPER )
						{
							G_PlayEffect( G_EffectIndex( "force/stormwindwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					//ACQUA 
					else if ( cent->gent->client->NPC_class == CLASS_SWAMP || cent->gent->client->NPC_class == CLASS_RAHABIM ||
						cent->gent->client->NPC_class == CLASS_SHARK || cent->gent->client->NPC_class == CLASS_SWAMPTROOPER || 
						cent->gent->client->NPC_class == CLASS_WATER || cent->gent->client->NPC_class == CLASS_GOLEM_WATER )
						{
							G_PlayEffect( G_EffectIndex( "force/waterwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// GHIACCIO
					else if ( cent->gent->client->NPC_class == CLASS_BARTENDER || cent->gent->client->NPC_class == CLASS_ICEREAVER 
						|| cent->gent->client->NPC_class == CLASS_GOLEM_ICE || cent->gent->client->NPC_class == CLASS_RAZIELHIM )
						{
							G_PlayEffect( G_EffectIndex( "force/icewide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// CRISTALLO 
					else if ( cent->gent->client->NPC_class == CLASS_WEEQUAY || cent->gent->client->NPC_class == CLASS_CRYSTAL ||
						cent->gent->client->NPC_class == CLASS_GALAKMECH ||cent->gent->client->NPC_class == CLASS_ESKANDOR )
						{
							G_PlayEffect( G_EffectIndex( "force/crystalwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// PIETRA 
				else if ( cent->gent->client->NPC_class == CLASS_LIZARD || cent->gent->client->NPC_class == CLASS_EARTH || 
						cent->gent->client->NPC_class == CLASS_EARTHREAVER || cent->gent->client->NPC_class == CLASS_GONK ||
						cent->gent->client->NPC_class == CLASS_DEMON_BLADE || cent->gent->client->NPC_class == CLASS_GOLEM )
						{
							G_PlayEffect( G_EffectIndex( "force/stonewide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
					// SUONO					
					else if ( cent->gent->client->NPC_class == CLASS_VAMPIRE_SOUND || cent->gent->client->NPC_class == CLASS_SENTRY || cent->gent->client->NPC_class == CLASS_HOWLER || 
						cent->gent->client->NPC_class == CLASS_SONIC || cent->gent->client->NPC_class == CLASS_GOLEM_SONIC ) 
						{
							G_PlayEffect( G_EffectIndex( "force/sonicwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// ASTRALE 
					else if ( cent->gent->client->NPC_class == CLASS_LANDO )
						{
							G_PlayEffect( G_EffectIndex( "force/astralwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// PSICHICO
					else if ( cent->gent->client->NPC_class == CLASS_FLIER2 || cent->gent->client->NPC_class == CLASS_MENTALIST ||
						cent->gent->client->NPC_class == CLASS_DECEIVER )
						{
							G_PlayEffect( G_EffectIndex( "force/stunwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
					// ACIDO
					else if ( cent->gent->client->NPC_class == CLASS_NOGHRI || cent->gent->client->NPC_class == CLASS_PRISONER ||
						cent->gent->client->NPC_class == CLASS_DREADNOUGHT || cent->gent->client->NPC_class == CLASS_BEAST )
						{
							G_PlayEffect( G_EffectIndex( "force/acidwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
					// VELENO 
				else if ( cent->gent->client->NPC_class == CLASS_MINEMONSTER || cent->gent->client->NPC_class == CLASS_POISON ||
						cent->gent->client->NPC_class == CLASS_IVY || cent->gent->client->NPC_class == CLASS_DEMON_POISON ||
						cent->gent->client->NPC_class == CLASS_GOLEM_POISON || 
						cent->gent->client->NPC_class == CLASS_RANCOR || cent->gent->client->NPC_class == CLASS_INTERROGATOR )
						{
							G_PlayEffect( G_EffectIndex( "force/poisonwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
					// MAGIA NERA 
					else if ( cent->gent->client->NPC_class == CLASS_TUSKEN || cent->gent->client->NPC_class == CLASS_MELC ||
						cent->gent->client->NPC_class == CLASS_SUMMONER || cent->gent->client->NPC_class == CLASS_THRALL ||
					cent->gent->client->NPC_class == CLASS_GLIDER || cent->gent->client->NPC_class == CLASS_COMMANDO ||
					cent->gent->client->NPC_class == CLASS_ARIEL || cent->gent->client->NPC_class == CLASS_GOLEM_NECRO ||
					cent->gent->client->NPC_class == CLASS_VAMPIRE_ZOMBIE )
						{
							G_PlayEffect( G_EffectIndex( "force/necrowide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
					// MAGIA NECROTICA
					else if ( cent->gent->client->NPC_class == CLASS_FISH || cent->gent->client->NPC_class == CLASS_NECRO ||
						cent->gent->client->NPC_class == CLASS_MURJJ )
						{
							G_PlayEffect( G_EffectIndex( "force/skullwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
				// FUOCO DRUIDICO
				else if ( cent->gent->client->NPC_class == CLASS_TRANDOSHAN || cent->gent->client->NPC_class == CLASS_DRUIDREAVER || cent->gent->client->NPC_class == CLASS_DRUID )
						{
							G_PlayEffect( G_EffectIndex( "force/hollyfirewide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
				// FUOCO SACRO
					else if ( cent->gent->client->NPC_class == CLASS_JAN || cent->gent->client->NPC_class == CLASS_WARRIOR ||
						cent->gent->client->NPC_class == CLASS_STORMTROOPER ||cent->gent->client->NPC_class == CLASS_SARAFAN ||
						cent->gent->client->NPC_class == CLASS_HOLY || cent->gent->client->NPC_class == CLASS_PROPHET ||
						cent->gent->client->NPC_class == CLASS_GOLEM_HOLY ||
						cent->gent->client->NPC_class == CLASS_RAZIEL )
						{
							G_PlayEffect( G_EffectIndex( "force/hollywide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}
				// NATURA
				else if ( cent->gent->client->NPC_class == CLASS_LUKE )
					{
						G_PlayEffect( G_EffectIndex( "force/lifewide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
					} 
				// FUOCO HYLDEN
					else if ( cent->gent->client->NPC_class == CLASS_TAVION || cent->gent->client->NPC_class == CLASS_HYLDEN ||
						cent->gent->client->NPC_class == CLASS_PROPHET || cent->gent->client->NPC_class == CLASS_HYLDENLORD )
						{
							G_PlayEffect( G_EffectIndex( "force/hyldenwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						} 
				// FOLGORI HYLDEN 
				else if ( cent->gent->client->NPC_class == CLASS_DESANN || cent->gent->client->NPC_class == CLASS_SAND_CREATURE ||
						cent->gent->client->NPC_class == CLASS_TENTACLE || cent->gent->client->NPC_class == CLASS_ELDERGOD )
						{
							G_PlayEffect( G_EffectIndex( "force/greenlightningwide" ), cent->gent->client->renderInfo.handLPoint, fxAxis );
						}			
				if ( cent->gent->client->ps.torsoAnim == BOTH_FORCE_2HANDEDLIGHTNING
					...
					if ( cent->gent->client->NPC_class == CLASS_REELO || cent->gent->client->NPC_class == CLASS_SPIDERREAVER ||
						...
						cent->gent->client->NPC_class == CLASS_ZEPH || cent->gent->client->NPC_class == CLASS_UGNAUGHT )
						{
							G_PlayEffect( G_EffectIndex( "force/webwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
					// RIVERBERO 
					else if ( cent->gent->client->NPC_class == CLASS_MOUSE ||
						cent->gent->client->NPC_class == CLASS_JAWA || cent->gent->client->NPC_class == CLASS_NECROREAVER ||
						...
						cent->gent->client->NPC_class == CLASS_VAMPIRE_GHOST )
						{
							G_PlayEffect( G_EffectIndex( "force/ghostwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
					// ENERGY BOLT - LIGHTNING 
					else if ( cent->gent->client->NPC_class == CLASS_REBORN || cent->gent->client->NPC_class == CLASS_VAMPIRE ||
						cent->gent->client->NPC_class == CLASS_TURELIM || cent->gent->client->NPC_class == CLASS_GRAN ||
						...
						cent->gent->client->NPC_class == CLASS_VAMPIRE_LYCAN || cent->gent->client->NPC_class == CLASS_VAMPIRE_BLOOD )
						{
							G_PlayEffect( G_EffectIndex( "force/lightningwide2" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
					// ELETTRICITA' 
					else if ( cent->gent->client->NPC_class == CLASS_JEDI ||
						cent->gent->client->NPC_class == CLASS_REAVER ||
						...
						cent->gent->client->NPC_class == CLASS_DEMON_ELECTRO || cent->gent->client->NPC_class == CLASS_GOLEM_METAL )
						{
							G_PlayEffect( G_EffectIndex( "force/lightningwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// TENEBRE 
					else if ( cent->gent->client->NPC_class == CLASS_SABOTEUR ||
						cent->gent->client->NPC_class == CLASS_DARK || cent->gent->client->NPC_class == CLASS_GOLEM_DARK ||
						cent->gent->client->NPC_class == CLASS_DARKREAVER )
						{
							G_PlayEffect( G_EffectIndex( "force/darkwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// FUMO 
					else if ( cent->gent->client->NPC_class == CLASS_BESPIN_COP ||  cent->gent->client->NPC_class == CLASS_TANKREAVER ||
							cent->gent->client->NPC_class == CLASS_GOLEM_SMOKE )
						{
							G_PlayEffect( G_EffectIndex( "force/smogwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// VUOTO
					else if ( cent->gent->client->NPC_class == CLASS_SHADOWTROOPER || cent->gent->client->NPC_class == CLASS_VOID ||
						cent->gent->client->NPC_class == CLASS_GOLEM_VOID )
						{
							G_PlayEffect( G_EffectIndex( "force/voidwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// FOLGORI LUCENTI 
					else if ( cent->gent->client->NPC_class == CLASS_SABER_DROID || cent->gent->client->NPC_class == CLASS_ASSASSIN_DROID || 
						cent->gent->client->NPC_class == CLASS_LIGHT || cent->gent->client->NPC_class == CLASS_LIGHTREAVER ||
						cent->gent->client->NPC_class == CLASS_GOLEM_LIGHT )
						{
							G_PlayEffect( G_EffectIndex( "force/yellowlightningwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
					// RADIANZA
					else if ( cent->gent->client->NPC_class == CLASS_MORGANKATARN || cent->gent->client->NPC_class == CLASS_PROTOCOL || 
						cent->gent->client->NPC_class == CLASS_ATST || cent->gent->client->NPC_class == CLASS_GOLEM_GOLD )
						{
							G_PlayEffect( G_EffectIndex( "force/burstwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// PALLE DI FUOCO 
					else if ( cent->gent->client->NPC_class == CLASS_RODIAN || cent->gent->client->NPC_class == CLASS_HUNTER ||
							cent->gent->client->NPC_class == CLASS_GALAK ||	cent->gent->client->NPC_class == CLASS_ARCHER || 
							...
							cent->gent->client->NPC_class == CLASS_HELLGOLEM )
						{
							G_PlayEffect( G_EffectIndex( "force/fireballwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// FUOCO 
					else if ( cent->gent->client->NPC_class == CLASS_IMPWORKER || cent->gent->client->NPC_class == CLASS_WIZARD ||
						cent->gent->client->NPC_class == CLASS_FIRE || cent->gent->client->NPC_class == CLASS_GOLEM_FIRE )
						{
							G_PlayEffect( G_EffectIndex( "force/firewide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// CALORE - FIAMME INFERNALI 
					else if ( cent->gent->client->NPC_class == CLASS_WAMPA || cent->gent->client->NPC_class == CLASS_VAMPIRE_DEMON ||
						cent->gent->client->NPC_class == CLASS_DEMON_FIRE || cent->gent->client->NPC_class == CLASS_FIREREAVER || 
						...
						cent->gent->client->NPC_class == CLASS_VAMPIRE_FEAR2 )
						{
							G_PlayEffect( G_EffectIndex( "force/hellwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
					// MAGMA 
					else if ( cent->gent->client->NPC_class == CLASS_CLAW || cent->gent->client->NPC_class == CLASS_GOLEM_LAVA )
						{
							G_PlayEffect( G_EffectIndex( "force/lavawide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
					// VENTO 
					else if ( cent->gent->client->NPC_class == CLASS_PROBE || 
						cent->gent->client->NPC_class == CLASS_POLTER || 
						...
						cent->gent->client->NPC_class == CLASS_AIRREAVER )
						{
							G_PlayEffect( G_EffectIndex( "force/windwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// STORM
					else if ( cent->gent->client->NPC_class == CLASS_ROCKETTROOPER )
						{
							G_PlayEffect( G_EffectIndex( "force/stormwindwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					//ACQUA 
					else if ( cent->gent->client->NPC_class == CLASS_SWAMP || cent->gent->client->NPC_class == CLASS_RAHABIM ||
						cent->gent->client->NPC_class == CLASS_SHARK || cent->gent->client->NPC_class == CLASS_SWAMPTROOPER || 
						cent->gent->client->NPC_class == CLASS_WATER || cent->gent->client->NPC_class == CLASS_GOLEM_WATER )
						{
							G_PlayEffect( G_EffectIndex( "force/waterwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// GHIACCIO
					else if ( cent->gent->client->NPC_class == CLASS_BARTENDER || cent->gent->client->NPC_class == CLASS_ICEREAVER 
						|| cent->gent->client->NPC_class == CLASS_GOLEM_ICE || cent->gent->client->NPC_class == CLASS_RAZIELHIM )
						{
							G_PlayEffect( G_EffectIndex( "force/icewide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// CRISTALLO 
					else if ( cent->gent->client->NPC_class == CLASS_WEEQUAY || cent->gent->client->NPC_class == CLASS_CRYSTAL ||
						cent->gent->client->NPC_class == CLASS_GALAKMECH || cent->gent->client->NPC_class == CLASS_ESKANDOR )
						{
							G_PlayEffect( G_EffectIndex( "force/crystalwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// PIETRA 
				else if ( cent->gent->client->NPC_class == CLASS_LIZARD || cent->gent->client->NPC_class == CLASS_EARTH || 
						cent->gent->client->NPC_class == CLASS_EARTHREAVER || cent->gent->client->NPC_class == CLASS_GONK ||
						cent->gent->client->NPC_class == CLASS_DEMON_BLADE || cent->gent->client->NPC_class == CLASS_GOLEM )
						{
							G_PlayEffect( G_EffectIndex( "force/stonewide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
					// SUONO					
					else if ( cent->gent->client->NPC_class == CLASS_VAMPIRE_SOUND || cent->gent->client->NPC_class == CLASS_SENTRY || cent->gent->client->NPC_class == CLASS_HOWLER || 
						cent->gent->client->NPC_class == CLASS_SONIC || cent->gent->client->NPC_class == CLASS_GOLEM_SONIC ) 
						{
							G_PlayEffect( G_EffectIndex( "force/sonicwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// ASTRALE 
					else if ( cent->gent->client->NPC_class == CLASS_LANDO )
						{
							G_PlayEffect( G_EffectIndex( "force/astralwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// PSICHICO
					else if ( cent->gent->client->NPC_class == CLASS_FLIER2 || cent->gent->client->NPC_class == CLASS_MENTALIST ||
						cent->gent->client->NPC_class == CLASS_DECEIVER )
						{
							G_PlayEffect( G_EffectIndex( "force/stunwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
					// ACIDO
					else if ( cent->gent->client->NPC_class == CLASS_NOGHRI || cent->gent->client->NPC_class == CLASS_PRISONER ||
						cent->gent->client->NPC_class == CLASS_DREADNOUGHT || cent->gent->client->NPC_class == CLASS_BEAST )
						{
							G_PlayEffect( G_EffectIndex( "force/acidwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
					// VELENO 
				else if ( cent->gent->client->NPC_class == CLASS_MINEMONSTER || cent->gent->client->NPC_class == CLASS_POISON ||
						cent->gent->client->NPC_class == CLASS_IVY || cent->gent->client->NPC_class == CLASS_DEMON_POISON ||
						...
						cent->gent->client->NPC_class == CLASS_RANCOR || cent->gent->client->NPC_class == CLASS_INTERROGATOR )
						{
							G_PlayEffect( G_EffectIndex( "force/poisonwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
					// MAGIA NERA 
					else if ( cent->gent->client->NPC_class == CLASS_TUSKEN || cent->gent->client->NPC_class == CLASS_MELC ||
						cent->gent->client->NPC_class == CLASS_SUMMONER || cent->gent->client->NPC_class == CLASS_THRALL ||
						...
						cent->gent->client->NPC_class == CLASS_VAMPIRE_ZOMBIE )
						{
							G_PlayEffect( G_EffectIndex( "force/necrowide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
					// MAGIA NECROTICA
					else if ( cent->gent->client->NPC_class == CLASS_FISH || cent->gent->client->NPC_class == CLASS_NECRO ||
						cent->gent->client->NPC_class == CLASS_MURJJ )
						{
							G_PlayEffect( G_EffectIndex( "force/skullwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
				// FUOCO DRUIDICO
				else if ( cent->gent->client->NPC_class == CLASS_TRANDOSHAN || cent->gent->client->NPC_class == CLASS_DRUIDREAVER || cent->gent->client->NPC_class == CLASS_DRUID )
						{
							G_PlayEffect( G_EffectIndex( "force/hollyfirewide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
				// FUOCO SACRO
					else if ( cent->gent->client->NPC_class == CLASS_JAN || cent->gent->client->NPC_class == CLASS_WARRIOR ||
						cent->gent->client->NPC_class == CLASS_STORMTROOPER ||cent->gent->client->NPC_class == CLASS_SARAFAN ||
						cent->gent->client->NPC_class == CLASS_HOLY || cent->gent->client->NPC_class == CLASS_PROPHET ||
						cent->gent->client->NPC_class == CLASS_GOLEM_HOLY || cent->gent->client->NPC_class == CLASS_ARIEL ||
						cent->gent->client->NPC_class == CLASS_RAZIEL )
						{
							G_PlayEffect( G_EffectIndex( "force/hollywide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}
				// NATURA
				else if ( cent->gent->client->NPC_class == CLASS_LUKE )
					{
						G_PlayEffect( G_EffectIndex( "force/lifewide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
					} 
				// FUOCO HYLDEN
					else if ( cent->gent->client->NPC_class == CLASS_TAVION || cent->gent->client->NPC_class == CLASS_HYLDEN ||
						cent->gent->client->NPC_class == CLASS_PROPHET )
						{
							G_PlayEffect( G_EffectIndex( "force/hyldenwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						} 
				// FOLGORI HYLDEN 
				else if ( cent->gent->client->NPC_class == CLASS_DESANN || cent->gent->client->NPC_class == CLASS_SAND_CREATURE ||
						cent->gent->client->NPC_class == CLASS_TENTACLE || cent->gent->client->NPC_class == CLASS_ELDERGOD ||
						cent->gent->client->NPC_class == CLASS_HYLDENLORD )
						{
							G_PlayEffect( G_EffectIndex( "force/greenlightningwide" ), cent->gent->client->renderInfo.handRPoint, fxAxis );
						}		
					}
				}
				else
				{//line
					...
					if ( cent->gent->client->NPC_class == CLASS_REELO || cent->gent->client->NPC_class == CLASS_SPIDERREAVER ||
						...
						cent->gent->client->NPC_class == CLASS_ZEPH || cent->gent->client->NPC_class == CLASS_UGNAUGHT )
						{
							G_PlayEffect( G_EffectIndex( "force/web" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						} 
					// RIVERBERO 
					else if ( cent->gent->client->NPC_class == CLASS_MOUSE ||
						cent->gent->client->NPC_class == CLASS_JAWA || cent->gent->client->NPC_class == CLASS_NECROREAVER ||
						...
						cent->gent->client->NPC_class == CLASS_VAMPIRE_GHOST )
						{
							G_PlayEffect( G_EffectIndex( "force/ghost" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						} 
					// ENERGY BOLT - LIGHTNING 
					else if ( cent->gent->client->NPC_class == CLASS_REBORN || cent->gent->client->NPC_class == CLASS_VAMPIRE ||
						cent->gent->client->NPC_class == CLASS_TURELIM || cent->gent->client->NPC_class == CLASS_GRAN ||
						...
						cent->gent->client->NPC_class == CLASS_VAMPIRE_QUEEN || cent->gent->client->NPC_class == CLASS_VAMPIRE_WATER ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_ARCHER ||
						cent->gent->client->NPC_class == CLASS_JEDI ||
						cent->gent->client->NPC_class == CLASS_REAVER || cent->gent->client->NPC_class == CLASS_VAMPIRE_FROST ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_FEAR || cent->gent->client->NPC_class == CLASS_VAMPIRE_ELF ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_ELF2 || cent->gent->client->NPC_class == CLASS_VAMPIRE_ELF3 ||
						cent->gent->client->NPC_class == CLASS_HALFVAMPIRE ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_SARAFAN ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_LYCAN || cent->gent->client->NPC_class == CLASS_VAMPIRE_BLOOD )
						{
							G_PlayEffect( G_EffectIndex( "force/lightning" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}					
					// ELETTRICITA' 
					else if ( cent->gent->client->NPC_class == CLASS_SEEKER || cent->gent->client->NPC_class == CLASS_REMOTE || 
						 cent->gent->client->NPC_class == CLASS_MARK1 || cent->gent->client->NPC_class == CLASS_MARK2 ||
						cent->gent->client->NPC_class == CLASS_R2D2 || cent->gent->client->NPC_class == CLASS_R5D2 ||
						cent->gent->client->NPC_class == CLASS_DEMON_ELECTRO || cent->gent->client->NPC_class == CLASS_GOLEM_METAL )
						{
					...
					// TENEBRE 
						...
						cent->gent->client->NPC_class == CLASS_DARKREAVER )
						{
							G_PlayEffect( G_EffectIndex( "force/dark" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// FUMO 
					else if ( cent->gent->client->NPC_class == CLASS_BESPIN_COP ||  cent->gent->client->NPC_class == CLASS_TANKREAVER ||
							cent->gent->client->NPC_class == CLASS_GOLEM_SMOKE )
						{
							G_PlayEffect( G_EffectIndex( "force/smog" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// VUOTO
					else if ( cent->gent->client->NPC_class == CLASS_SHADOWTROOPER || cent->gent->client->NPC_class == CLASS_VOID ||
						cent->gent->client->NPC_class == CLASS_GOLEM_VOID )
						{
							G_PlayEffect( G_EffectIndex( "force/void" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// FOLGORI LUCENTI 
					else if ( cent->gent->client->NPC_class == CLASS_SABER_DROID || cent->gent->client->NPC_class == CLASS_ASSASSIN_DROID || 
						cent->gent->client->NPC_class == CLASS_LIGHT || cent->gent->client->NPC_class == CLASS_LIGHTREAVER ||
						cent->gent->client->NPC_class == CLASS_GOLEM_LIGHT )
						{
							G_PlayEffect( G_EffectIndex( "force/yellowlightning" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						} 
					// RADIANZA
					else if ( cent->gent->client->NPC_class == CLASS_MORGANKATARN || cent->gent->client->NPC_class == CLASS_PROTOCOL || 
						cent->gent->client->NPC_class == CLASS_ATST || cent->gent->client->NPC_class == CLASS_GOLEM_GOLD )
						{
							G_PlayEffect( G_EffectIndex( "force/burst" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// PALLE DI FUOCO 
					else if ( cent->gent->client->NPC_class == CLASS_RODIAN || cent->gent->client->NPC_class == CLASS_HUNTER ||
							cent->gent->client->NPC_class == CLASS_GALAK ||	cent->gent->client->NPC_class == CLASS_ARCHER || 
							...
							cent->gent->client->NPC_class == CLASS_HELLGOLEM )
						{
							G_PlayEffect( G_EffectIndex( "force/fireball" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// FUOCO 
					else if ( cent->gent->client->NPC_class == CLASS_IMPWORKER || cent->gent->client->NPC_class == CLASS_WIZARD ||
						cent->gent->client->NPC_class == CLASS_FIRE || cent->gent->client->NPC_class == CLASS_GOLEM_FIRE )
						{
							G_PlayEffect( G_EffectIndex( "force/fire" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// CALORE - FIAMME INFERNALI 
					else if ( cent->gent->client->NPC_class == CLASS_WAMPA || cent->gent->client->NPC_class == CLASS_VAMPIRE_DEMON ||
						cent->gent->client->NPC_class == CLASS_DEMON_FIRE || cent->gent->client->NPC_class == CLASS_FIREREAVER || 
						...
						cent->gent->client->NPC_class == CLASS_VAMPIRE_FEAR2 )
						{
							G_PlayEffect( G_EffectIndex( "force/hell" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						} 
					// MAGMA 
					else if ( cent->gent->client->NPC_class == CLASS_CLAW || cent->gent->client->NPC_class == CLASS_GOLEM_LAVA )
						{
							G_PlayEffect( G_EffectIndex( "force/lava" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						} 
					// VENTO 
					else if ( cent->gent->client->NPC_class == CLASS_PROBE || 
						cent->gent->client->NPC_class == CLASS_POLTER || 
						...
						cent->gent->client->NPC_class == CLASS_AIRREAVER )
						{
							G_PlayEffect( G_EffectIndex( "force/wind" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// STORM
					else if ( cent->gent->client->NPC_class == CLASS_ROCKETTROOPER )
						{
							G_PlayEffect( G_EffectIndex( "force/stormwind" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					//ACQUA 
					else if ( cent->gent->client->NPC_class == CLASS_SWAMP || cent->gent->client->NPC_class == CLASS_RAHABIM ||
						cent->gent->client->NPC_class == CLASS_SHARK || cent->gent->client->NPC_class == CLASS_SWAMPTROOPER || 
						cent->gent->client->NPC_class == CLASS_WATER || cent->gent->client->NPC_class == CLASS_GOLEM_WATER )
						{
							G_PlayEffect( G_EffectIndex( "force/water" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// GHIACCIO
					else if ( cent->gent->client->NPC_class == CLASS_BARTENDER || cent->gent->client->NPC_class == CLASS_ICEREAVER 
						|| cent->gent->client->NPC_class == CLASS_GOLEM_ICE || cent->gent->client->NPC_class == CLASS_RAZIELHIM )
						{
							G_PlayEffect( G_EffectIndex( "force/ice" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// CRISTALLO 
					else if ( cent->gent->client->NPC_class == CLASS_WEEQUAY || cent->gent->client->NPC_class == CLASS_CRYSTAL ||
						cent->gent->client->NPC_class == CLASS_GALAKMECH || cent->gent->client->NPC_class == CLASS_ESKANDOR )
						{
							G_PlayEffect( G_EffectIndex( "force/crystal" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// PIETRA 
				else if ( cent->gent->client->NPC_class == CLASS_LIZARD || cent->gent->client->NPC_class == CLASS_EARTH || 
						cent->gent->client->NPC_class == CLASS_EARTHREAVER || cent->gent->client->NPC_class == CLASS_GONK ||
						cent->gent->client->NPC_class == CLASS_DEMON_BLADE || cent->gent->client->NPC_class == CLASS_GOLEM )
						{
							G_PlayEffect( G_EffectIndex( "force/stone" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						} 
					// SUONO					
					else if ( cent->gent->client->NPC_class == CLASS_VAMPIRE_SOUND || cent->gent->client->NPC_class == CLASS_SENTRY || cent->gent->client->NPC_class == CLASS_HOWLER || 
						cent->gent->client->NPC_class == CLASS_SONIC || cent->gent->client->NPC_class == CLASS_GOLEM_SONIC ) 
						{
							G_PlayEffect( G_EffectIndex( "force/sonic" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// ASTRALE 
					else if ( cent->gent->client->NPC_class == CLASS_LANDO )
						{
							G_PlayEffect( G_EffectIndex( "force/astral" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// PSICHICO
					else if ( cent->gent->client->NPC_class == CLASS_FLIER2 || cent->gent->client->NPC_class == CLASS_MENTALIST ||
						cent->gent->client->NPC_class == CLASS_DECEIVER )
						{
							G_PlayEffect( G_EffectIndex( "force/stun" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						} 
					// ACIDO
					else if ( cent->gent->client->NPC_class == CLASS_NOGHRI || cent->gent->client->NPC_class == CLASS_PRISONER ||
						cent->gent->client->NPC_class == CLASS_DREADNOUGHT || cent->gent->client->NPC_class == CLASS_BEAST )
						{
							G_PlayEffect( G_EffectIndex( "force/acid" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					// VELENO 
				else if ( cent->gent->client->NPC_class == CLASS_MINEMONSTER || cent->gent->client->NPC_class == CLASS_POISON ||
						cent->gent->client->NPC_class == CLASS_IVY || cent->gent->client->NPC_class == CLASS_DEMON_POISON ||
						...
						cent->gent->client->NPC_class == CLASS_RANCOR || cent->gent->client->NPC_class == CLASS_INTERROGATOR )
						{
							G_PlayEffect( G_EffectIndex( "force/poison" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						} 
					// MAGIA NERA 
					else if ( cent->gent->client->NPC_class == CLASS_TUSKEN || cent->gent->client->NPC_class == CLASS_MELC ||
						cent->gent->client->NPC_class == CLASS_SUMMONER || cent->gent->client->NPC_class == CLASS_THRALL ||
					...
					cent->gent->client->NPC_class == CLASS_VAMPIRE_ZOMBIE )
						{
							G_PlayEffect( G_EffectIndex( "force/necro" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						} 
					// MAGIA NECROTICA
					else if ( cent->gent->client->NPC_class == CLASS_FISH || cent->gent->client->NPC_class == CLASS_NECRO ||
						cent->gent->client->NPC_class == CLASS_MURJJ )
						{
							G_PlayEffect( G_EffectIndex( "force/skull" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						} 
				// FUOCO DRUIDICO
				else if ( cent->gent->client->NPC_class == CLASS_TRANDOSHAN || cent->gent->client->NPC_class == CLASS_DRUIDREAVER || cent->gent->client->NPC_class == CLASS_DRUID )
						{
							G_PlayEffect( G_EffectIndex( "force/hollyfire" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						} 
				// FUOCO SACRO
					else if ( cent->gent->client->NPC_class == CLASS_JAN || cent->gent->client->NPC_class == CLASS_WARRIOR ||
						cent->gent->client->NPC_class == CLASS_STORMTROOPER ||cent->gent->client->NPC_class == CLASS_SARAFAN ||
						...
						cent->gent->client->NPC_class == CLASS_RAZIEL )
						{
							G_PlayEffect( G_EffectIndex( "force/holly" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
				// NATURA
				else if ( cent->gent->client->NPC_class == CLASS_LUKE )
					{
						G_PlayEffect( G_EffectIndex( "force/life" ), cent->gent->client->renderInfo.handLPoint, fxDir );
					} 
				// FUOCO HYLDEN
					else if ( cent->gent->client->NPC_class == CLASS_TAVION || cent->gent->client->NPC_class == CLASS_HYLDEN ||
						cent->gent->client->NPC_class == CLASS_PROPHET || cent->gent->client->NPC_class == CLASS_HYLDENLORD )
						{
							G_PlayEffect( G_EffectIndex( "force/hylden" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						} 
				// FOLGORI HYLDEN 
				else if ( cent->gent->client->NPC_class == CLASS_DESANN || cent->gent->client->NPC_class == CLASS_SAND_CREATURE ||
						cent->gent->client->NPC_class == CLASS_TENTACLE || cent->gent->client->NPC_class == CLASS_ELDERGOD )
						{
							G_PlayEffect( G_EffectIndex( "force/greenlightning" ), cent->gent->client->renderInfo.handLPoint, fxDir );
						}
					}
				}
			...
			if ( (cent->gent->client->ps.eFlags&EF_POWERING_ROSH) )
			{
				...
				VectorCopy( cent->lerpAngles, tAng );
				AngleVectors( tAng, fxDir, NULL, NULL );
				G_PlayEffect( G_EffectIndex( "force/dr1" ), cent->gent->client->renderInfo.handLPoint, fxDir );
			}
			...
			{//doing the draining and not on a single person
				...
				{//arc
					vec3_t	fxAxis[3];
					AnglesToAxis( tAng, fxAxis ); // GHOST AND WIND DRAIN 
					...
					if ( cent->gent->client->NPC_class == CLASS_REELO || cent->gent->client->NPC_class == CLASS_PROBE ||
						 cent->gent->client->NPC_class == CLASS_UGNAUGHT ||  cent->gent->client->NPC_class == CLASS_REBEL || 
						 ...
						 cent->gent->client->NPC_class == CLASS_RAZIEL || cent->gent->client->NPC_class == CLASS_HOLY ||
						 cent->gent->client->NPC_class == CLASS_MENTALIST ||  cent->gent->client->NPC_class == CLASS_DRUIDREAVER || 
						 cent->gent->client->NPC_class == CLASS_LANDO || cent->gent->client->NPC_class == CLASS_NECROREAVER ||
						 cent->gent->client->NPC_class == CLASS_DARKREAVER || cent->gent->client->NPC_class == CLASS_TANKREAVER ||
						 cent->gent->client->NPC_class == CLASS_LIGHTREAVER || cent->gent->client->NPC_class == CLASS_FIREREAVER ||
						 cent->gent->client->NPC_class == CLASS_AIRREAVER || cent->gent->client->NPC_class == CLASS_ICEREAVER ||
						 cent->gent->client->NPC_class == CLASS_EARTHREAVER || cent->gent->client->NPC_class == CLASS_REAVER ||
						 cent->gent->client->NPC_class == CLASS_VAMPIRE_GHOST || cent->gent->client->NPC_class == CLASS_GHOST ||
						 cent->gent->client->NPC_class == CLASS_REAPER || cent->gent->client->NPC_class == CLASS_DREADNOUGHT ||
						 cent->gent->client->NPC_class == CLASS_TENTACLE || cent->gent->client->NPC_class == CLASS_ELDERGOD ||
						 cent->gent->client->NPC_class == CLASS_POLTER || cent->gent->client->NPC_class == CLASS_AIR ||  			
						 cent->gent->client->NPC_class == CLASS_GLIDER || cent->gent->client->NPC_class == CLASS_GOLEM_AIR || 
						 cent->gent->client->NPC_class == CLASS_GOLEM_METAL || cent->gent->client->NPC_class == CLASS_GOLEM_HOLY ) 
						{
						...
						else if ( cent->gent->client->NPC_class == CLASS_JEDI )
						{
						 ...
						 cent->gent->client->NPC_class == CLASS_FLIER2 || cent->gent->client->NPC_class == CLASS_WEEQUAY || cent->gent->client->NPC_class == CLASS_LIZARD ||
						 ...
						 cent->gent->client->NPC_class == CLASS_VAMPIRE || cent->gent->client->NPC_class == CLASS_KAIN ||
						 cent->gent->client->NPC_class == CLASS_MELC || cent->gent->client->NPC_class == CLASS_SUMMONER || 
						 cent->gent->client->NPC_class == CLASS_ZEPH || cent->gent->client->NPC_class == CLASS_DECEIVER || 
						 cent->gent->client->NPC_class == CLASS_DUMAHIM || cent->gent->client->NPC_class == CLASS_RAHABIM || 
						 cent->gent->client->NPC_class == CLASS_TURELIM || cent->gent->client->NPC_class == CLASS_LYCAN || 
						 cent->gent->client->NPC_class == CLASS_BEAST || cent->gent->client->NPC_class == CLASS_SHARK || 
						 cent->gent->client->NPC_class == CLASS_BIRD || 						 
						 cent->gent->client->NPC_class == CLASS_KAIN2 || cent->gent->client->NPC_class == CLASS_KAIN3 ||
						 cent->gent->client->NPC_class == CLASS_VORADOR || cent->gent->client->NPC_class == CLASS_UMAH || 
						 cent->gent->client->NPC_class == CLASS_JANOS || cent->gent->client->NPC_class == CLASS_NECROMANCER || 
						 cent->gent->client->NPC_class == CLASS_VAMPIRE_QUEEN ||
						 cent->gent->client->NPC_class == CLASS_VAMPIRE_DARK || cent->gent->client->NPC_class == CLASS_VAMPIRE_WATER ||
						 cent->gent->client->NPC_class == CLASS_VAMPIRE_FEAR || cent->gent->client->NPC_class == CLASS_VAMPIRE_FROST ||
						 cent->gent->client->NPC_class == CLASS_VAMPIRE_ARCHER || cent->gent->client->NPC_class == CLASS_VAMPIRE_ELF ||
						 cent->gent->client->NPC_class == CLASS_VAMPIRE_ELF2 || cent->gent->client->NPC_class == CLASS_VAMPIRE_ELF3 ||
						 cent->gent->client->NPC_class == CLASS_RAZIELHIM || cent->gent->client->NPC_class == CLASS_HALFVAMPIRE ||
						 cent->gent->client->NPC_class == CLASS_VAMPIRE_BOUNTY || cent->gent->client->NPC_class == CLASS_VAMPIRE_ZOMBIE || 
						 cent->gent->client->NPC_class == CLASS_VAMPIRE_NECRO || cent->gent->client->NPC_class == CLASS_VAMPIRE_NECRO2 || 
						 cent->gent->client->NPC_class == CLASS_VAMPIRE_BLOOD || cent->gent->client->NPC_class == CLASS_VAMPIRE_LYCAN || 
						 cent->gent->client->NPC_class == CLASS_VAMPIRE_SARAFAN || cent->gent->client->NPC_class == CLASS_VAMPIRE_SOUND || 
						 cent->gent->client->NPC_class == CLASS_WOLFFORM || cent->gent->client->NPC_class == CLASS_WOLFKAIN || 
						 cent->gent->client->NPC_class == CLASS_WOLFKAIN2 || cent->gent->client->NPC_class == CLASS_WOLFKAIN3 ||
						  cent->gent->client->NPC_class == CLASS_WOLFFORM || cent->gent->client->NPC_class == CLASS_WOLFKAIN || 
						 cent->gent->client->NPC_class == CLASS_WOLFKAIN2 || cent->gent->client->NPC_class == CLASS_WOLFKAIN3 ||
						  cent->gent->client->NPC_class == CLASS_WOLFVORADOR || cent->gent->client->NPC_class == CLASS_WOLFJANOS || 
						 cent->gent->client->NPC_class == CLASS_WOLFNECROMANCER || cent->gent->client->NPC_class == CLASS_WOLFVAMPIRE_QUEEN ||
						  cent->gent->client->NPC_class == CLASS_WOLFHALFVAMPIRE || cent->gent->client->NPC_class == CLASS_ESKANDOR || 
						 cent->gent->client->NPC_class == CLASS_WOLFVAMPIRE_LYCAN || cent->gent->client->NPC_class == CLASS_WOLFVAMPIRE_FEAR ||
						  cent->gent->client->NPC_class == CLASS_WOLFVAMPIRE_ELF || cent->gent->client->NPC_class == CLASS_LIONVAMPIRE_ELF || 
						 cent->gent->client->NPC_class == CLASS_LIONVAMPIRE_ELF2 ) 
						{
						 ...
						 cent->gent->client->NPC_class == CLASS_PRISONER || 
						 ...
						 cent->gent->client->NPC_class == CLASS_DARK || cent->gent->client->NPC_class == CLASS_VOID ||
						 cent->gent->client->NPC_class == CLASS_EARTH || cent->gent->client->NPC_class == CLASS_CRYSTAL ||
						 cent->gent->client->NPC_class == CLASS_WATER || cent->gent->client->NPC_class == CLASS_SONIC ||
						 cent->gent->client->NPC_class == CLASS_FISH ||
						 ...
						 cent->gent->client->NPC_class == CLASS_NECRO || cent->gent->client->NPC_class == CLASS_THRALL ||
						 cent->gent->client->NPC_class == CLASS_ARCHER || cent->gent->client->NPC_class == CLASS_WARRIOR || 
						 cent->gent->client->NPC_class == CLASS_HUNTER || cent->gent->client->NPC_class == CLASS_ALCHEMIST || 
						 cent->gent->client->NPC_class == CLASS_SARAFAN || cent->gent->client->NPC_class == CLASS_DRUID ||
						 cent->gent->client->NPC_class == CLASS_CENOBITA || cent->gent->client->NPC_class == CLASS_GOLEM ||
						 cent->gent->client->NPC_class == CLASS_ARIEL || cent->gent->client->NPC_class == CLASS_GOLEM_SONIC ||
						 cent->gent->client->NPC_class == CLASS_GOLEM_DARK || cent->gent->client->NPC_class == CLASS_GOLEM_VOID ||
						 cent->gent->client->NPC_class == CLASS_GOLEM_SMOKE || cent->gent->client->NPC_class == CLASS_GOLEM_ICE ||
						 cent->gent->client->NPC_class == CLASS_GOLEM_WATER || cent->gent->client->NPC_class == CLASS_GOLEM_NECRO ) 
						{
						 ...
						 cent->gent->client->NPC_class == CLASS_DEMON_FIRE || cent->gent->client->NPC_class == CLASS_VAMPIRE_DEMON ||
						 cent->gent->client->NPC_class == CLASS_DEMON_BLADE || cent->gent->client->NPC_class == CLASS_DEMON_POISON ||
						 cent->gent->client->NPC_class == CLASS_DEMON_ELECTRO || cent->gent->client->NPC_class == CLASS_LIGHT ||
						  cent->gent->client->NPC_class == CLASS_FIRE || cent->gent->client->NPC_class == CLASS_GOLEM_FIRE ||
						cent->gent->client->NPC_class == CLASS_VAMPIRE_FEAR2 || cent->gent->client->NPC_class == CLASS_WOLFVAMPIRE_FEAR2 || 
						cent->gent->client->NPC_class == CLASS_GOLEM_LAVA || cent->gent->client->NPC_class == CLASS_HELLWOLF || 
						cent->gent->client->NPC_class == CLASS_GOLEM_LIGHT || cent->gent->client->NPC_class == CLASS_GOLEM_GOLD	 ) 
						{
						 ...
						 cent->gent->client->NPC_class == CLASS_IVY || cent->gent->client->NPC_class == CLASS_POISON ||
						 cent->gent->client->NPC_class == CLASS_PROPHET || cent->gent->client->NPC_class == CLASS_HYLDEN ||
						 cent->gent->client->NPC_class == CLASS_GOLEM_POISON || cent->gent->client->NPC_class == CLASS_HYLDENLORD  )
					{
...
// ORIGINAL LIGHTNING AND DRAIN CODE. 
/*	if ( cent->gent->client->ps.forcePowersActive&(1<<FP_LIGHTNING) )
			{//doing the electrocuting
				//FIXME: if the target is absorbing or blocking lightning w/saber, draw a beam from my hand to his (hand?chest?saber?)
				vec3_t tAng, fxDir;
	...
	if (torso.hModel) 
	{
		...
		if (head.hModel) 
		{
			...
			/*if ( cent->gent && cent->gent->NPC && ( cent->gent->NPC->confusionTime > cg.time || cent->gent->NPC->charmedTime > cg.time || cent->gent->NPC->controlledTime > cg.time) )
			{
				...
				if ( TIMER_Done( cent->gent, "confusionEffectDebounce" ) )
				{//ARGH!!!
					if (cent->gent->client->NPC_class == CLASS_SABOTEUR || cent->gent->client->NPC_class == CLASS_SHADOWTROOPER )
						{
							/*theFxScheduler.PlayEffect( cgs.effects.forceBlind, head.origin );
							TIMER_Set( cent->gent, "confusionEffectDebounce", 1000 );
						}
/*					theFxScheduler.PlayEffect( cgs.effects.forceConfusion, head.origin );
					TIMER_Set( cent->gent, "confusionEffectDebounce", 1000 );
...
//				VectorNormalize( cent->gent->client->renderInfo.muzzleDir );
	...
	if ( cent->currentState.number == 0 && cg.renderingThirdPerson )
	{
			...
			|| ( ps->weapon == WP_DEMP2 && ps->weaponstate == WEAPON_CHARGING_ALT ))
		{
			...
			else if ( ps->weapon == WP_BLASTER_PISTOL )
			{
				// Hardcoded max charge time of 1 second
				val = ( cg.time - ps->weaponChargeTime ) * 0.001f;
