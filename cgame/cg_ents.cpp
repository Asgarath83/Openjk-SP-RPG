...
static void CG_Missile( centity_t *cent ) {
	...
	else
	{
		...
		// Gun Library - Add Missile Sound 
		/*if ( cent->gent->client && cent->gent->client->gs.gun->Gun_Missile_Sound )
			{
				// custom Missile Looping sound
				cgi_S_AddLoopingSound( cent->currentState.number, cent->lerpOrigin, vec3_origin, cent->gent->client->gs.gun->Gun_Missile_Sound );
			}*/
