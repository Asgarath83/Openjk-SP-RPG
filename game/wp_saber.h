...
#define	FORCE_FREEZE_3_MIN_DIST	128.0f
#define	FORCE_FREEZE_3_MAX_DIST	256.0f
#define	FORCE_FREEZE_DIST			512.0f//FIXME: vary by power level?
#define	FORCE_FREEZE_DIST_SQUARED	(FORCE_FREEZE_DIST*FORCE_FREEZE_DIST)
...
#define FORCE_CONTROLMIND_DURATION 10000.0f
#define FORCE_TIME_DURATION 10000.0f
...
extern void G_CreateG2AttachedGunModel( gentity_t *ent, const char *gunModel, int boltNum, int GunNum );
extern void WP_GunAddG2GunModels( gentity_t *ent, int SpecificGunNum = -1); 
...
extern gentity_t *G_DropPistolItem( const char *PistolType, vec3_t PistolPos, vec3_t PistolVel, vec3_t PistolAngles, gentity_t *copyPistol = NULL );
