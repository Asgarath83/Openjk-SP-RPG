...
//	}
	...
	{//need to loop this in case we hit a Jedi who dodges the shot
		...
		if ( traceEnt // CAN DODGE ONLY: SCOUT WITH BOW, DUMAHIM REAPERS, AND DUMAHIM BOSSES. 
			&& ( traceEnt->s.weapon == WP_DISRUPTOR || (traceEnt->client && (traceEnt->client->NPC_class == CLASS_BOBAFETT||traceEnt->client->NPC_class == CLASS_WEEQUAY && traceEnt->s.weapon == WP_THERMAL ||traceEnt->client->NPC_class == CLASS_LIZARD ) ) ) )
