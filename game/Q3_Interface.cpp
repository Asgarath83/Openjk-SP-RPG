...
stringID_table_t WPTable[] =
{
	...
	ENUM2STRING(WP_BOW),
	ENUM2STRING(WP_CROSSBOW),
	ENUM2STRING(WP_SLING),
	ENUM2STRING(WP_THROWABLE),
	ENUM2STRING(WP_STUN_BATON),
	ENUM2STRING(WP_TUSKEN_STAFF),
	ENUM2STRING(WP_TUSKEN_RIFLE),
	ENUM2STRING(WP_CANNON),
	ENUM2STRING(WP_HOOKER),
	ENUM2STRING(WP_SCEPTER),
	ENUM2STRING(WP_DARK),
	ENUM2STRING(WP_LIGHT),
	ENUM2STRING(WP_LIGHTNING),
	ENUM2STRING(WP_FIRE),
	ENUM2STRING(WP_FLAME),
	ENUM2STRING(WP_AIR),
	ENUM2STRING(WP_WATER),
	ENUM2STRING(WP_EARTH),
	ENUM2STRING(WP_SONIC),
	ENUM2STRING(WP_PSYCHIC),
	ENUM2STRING(WP_WOOD),
	ENUM2STRING(WP_METAL),
	ENUM2STRING(WP_SPIRIT),
	ENUM2STRING(WP_POISON),
	ENUM2STRING(WP_HOLY),
	ENUM2STRING(WP_NECRO),
	...
	ENUM2STRING(WP_DEFENSE),
	ENUM2STRING(WP_POSITRON),
	ENUM2STRING(WP_DRONE),
	ENUM2STRING(WP_TURRET),			// turret guns 
	ENUM2STRING(WP_SUMMON1),
	ENUM2STRING(WP_SUMMON2),
	ENUM2STRING(WP_SUMMON3),
	ENUM2STRING(WP_SUMMON4),
	ENUM2STRING(WP_MORPH1),
	ENUM2STRING(WP_MORPH2),
	ENUM2STRING(WP_MORPH3),
	ENUM2STRING(WP_MORPH4),
	ENUM2STRING(WP_ITEM1),
	ENUM2STRING(WP_ITEM2),
	ENUM2STRING(WP_ITEM3),
	ENUM2STRING(WP_ITEM4),
	ENUM2STRING(WP_ITEM5),
	ENUM2STRING(WP_ITEM6),
	ENUM2STRING(WP_ITEM7),
	ENUM2STRING(WP_ITEM8),
	ENUM2STRING(WP_ITEM9),
	ENUM2STRING(WP_ITEM10),
	ENUM2STRING(WP_ITEM11),
	ENUM2STRING(WP_ITEM12),
	{ "", 0 }
};
...
stringID_table_t setTable[] =
{
	...
	ENUM2STRING(SET_FORCE_STUN_LEVEL),
	ENUM2STRING(SET_FORCE_HATE_LEVEL),
	ENUM2STRING(SET_FORCE_CONTROLMIND_LEVEL),
	ENUM2STRING(SET_FORCE_FREEZE_LEVEL),
	ENUM2STRING(SET_FORCE_HEALOTHER_LEVEL),
	ENUM2STRING(SET_FORCE_GLYPH_LEVEL),
	ENUM2STRING(SET_STONE_GLYPH_LEVEL),
	ENUM2STRING(SET_SOUND_GLYPH_LEVEL),
	ENUM2STRING(SET_WATER_GLYPH_LEVEL),
	ENUM2STRING(SET_FIRE_GLYPH_LEVEL),
	ENUM2STRING(SET_SUN_GLYPH_LEVEL),
	ENUM2STRING(SET_WIND_GLYPH_LEVEL),
	ENUM2STRING(SET_HOLY_GLYPH_LEVEL),
	ENUM2STRING(SET_DARK_GLYPH_LEVEL),
	ENUM2STRING(SET_NECRO_GLYPH_LEVEL),
	...
	ENUM2STRING(SET_FORCE_STUN),
	ENUM2STRING(SET_FORCE_HATE),
	ENUM2STRING(SET_FORCE_CONTROLMIND),
	ENUM2STRING(SET_FORCE_FREEZE),
	ENUM2STRING(SET_FORCE_HEALOTHER),
	ENUM2STRING(SET_FORCE_GLYPH),
	ENUM2STRING(SET_STONE_GLYPH),
	ENUM2STRING(SET_SOUND_GLYPH),
	ENUM2STRING(SET_WATER_GLYPH),
	ENUM2STRING(SET_FIRE_GLYPH),
	ENUM2STRING(SET_SUN_GLYPH),
	ENUM2STRING(SET_WIND_GLYPH),
	ENUM2STRING(SET_HOLY_GLYPH),
	ENUM2STRING(SET_DARK_GLYPH),
	ENUM2STRING(SET_NECRO_GLYPH),
...
extern int WP_GunInitData ( gentity_t *ent );
...
//		self->client->ps.stats[STAT_WEAPONS] = ( 1 << wp );
	...
	else if ( wp == WP_BLASTER_PISTOL ) 
	{
		if ( !hadWeapon )
		{
			WP_GunInitData( self );
		}
		WP_GunAddG2GunModels( self );
	}
	else
	{
...
////////////////////////////////////////////////////////////////////////////
//////// ASTROFANTASY NEW SCRIPT SYSTEM FUNCTIONS ///////////////////////
/*
/*
============
Q3_SetPlayerLevel
  ...
  Return type	: static void 
  Argument		:  int entID
  Argument		: const char *PlayerLevelName
============
*/
static void Q3_SetPlayerLevel ( int entID, const char *PlayerLevelName )
{
	gentity_t	*ent  = &g_entities[entID];

	if ( !ent )
	{
		Quake3Game()->DebugPrint( IGameInterface::WL_WARNING, "Q3_SetPlayerLevel: invalid entID %d\n", entID);
		return;
	}

	if ( !ent->client )
	{
		Quake3Game()->DebugPrint( IGameInterface::WL_ERROR, "Q3_SetPlayerLevel: ent %d is NOT a player!\n", entID);
		return;
	}
	// 1 -Assign the level to player 
	ent->client->PLAYERLEVEL = (Level_t)GetIDForString( LevelTable, PlayerLevelName ); 
	//ent->client->ls.PlayerLevel[NUM_LEVELS] = (Level_t)GetIDForString( LevelTable, PlayerLevelName );

	// 2 - cap health to the level value. 
	//g_entities[0].client->ls.PlayerLevel[NUM_LEVELS] = data;
	if ( g_entities[0].client->ls.PlayerLevel[NUM_LEVELS] < LEVEL_NONE )
	{
		g_entities[0].client->ls.PlayerLevel[NUM_LEVELS] = LEVEL_NONE;
	}
	else if ( g_entities[0].client->ls.PlayerLevel[NUM_LEVELS] > LEVEL100 )
	{
		g_entities[0].client->ls.PlayerLevel[NUM_LEVELS] = LEVEL100;
	}
	...
	switch ( ent->client->PLAYERLEVEL )
	{
		case LEVEL_NONE:  
		{
			ent->health = ent->max_health = 100;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 100;
			ent->client->ps.forcePowerMax = 100; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 1; 
		}
		break; 
		case LEVEL1:  
		{
			ent->health = ent->max_health = 110;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 110;
			ent->client->ps.forcePowerMax = 102; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 1; 
		}
		break; 
		case LEVEL2:  
		{
			ent->health = ent->max_health = 120;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 120;
			ent->client->ps.forcePowerMax = 104; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 1; 
		}
		break; 
		case LEVEL3:  
		{
			ent->health = ent->max_health = 130;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 130;
			ent->client->ps.forcePowerMax = 106; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 1; 
		}
		break; 
		case LEVEL4:  
		{
			ent->health = ent->max_health = 140;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 140;
			ent->client->ps.forcePowerMax = 108; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 1; 
		}
		break; 
		case LEVEL5:  
		{
			ent->health = ent->max_health = 150;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 150;
			ent->client->ps.forcePowerMax = 110; 
		...
		case LEVEL6:  
		{
			ent->health = ent->max_health = 160;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 160;
			ent->client->ps.forcePowerMax = 112; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 1; 
		}
		break; 
		case LEVEL7:  
		{
			ent->health = ent->max_health = 170;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 170;
			ent->client->ps.forcePowerMax = 114; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 1; 
		}
		break; 
		case LEVEL8:  
		{
			ent->health = ent->max_health = 180;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 180;
			ent->client->ps.forcePowerMax = 116; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 1; 
		}
		break; 
		case LEVEL9:  
		{
			ent->health = ent->max_health = 190;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 190;
			ent->client->ps.forcePowerMax = 118; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 1; 
		}
		break; 
		case LEVEL10:  
		{
			ent->health = ent->max_health = 200;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 200;
			ent->client->ps.forcePowerMax = 120; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 2; 
		}
		break; 
		case LEVEL11:  
		{
			ent->health = ent->max_health = 210;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 210;
			ent->client->ps.forcePowerMax = 121; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 2; 
		}
		break; 
		case LEVEL12:  
		{
			ent->health = ent->max_health = 220;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 220;
			ent->client->ps.forcePowerMax = 122; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 2; 
		}
		break; 
		case LEVEL13:  
		{
			ent->health = ent->max_health = 230;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 230;
			ent->client->ps.forcePowerMax = 123; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 2; 
		}
		break; 
		case LEVEL14:  
		{
			ent->health = ent->max_health = 240;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 240;
			ent->client->ps.forcePowerMax = 124; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 2; 
		}
		break; 
		case LEVEL15:  
		{
			...
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 250;
			ent->client->ps.forcePowerMax = 125; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 2; 
		}
		break; 
		case LEVEL16:  
		{
			ent->health = ent->max_health = 260;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 260;
			ent->client->ps.forcePowerMax = 126; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 2; 
		}
		break; 
		case LEVEL17:  
		{
			ent->health = ent->max_health = 270;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 270;
			ent->client->ps.forcePowerMax = 127; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 2; 
		}
		break; 
		case LEVEL18:  
		{
			ent->health = ent->max_health = 280;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 280;
			ent->client->ps.forcePowerMax = 128; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 2; 
		}
		break; 
		case LEVEL19:  
		{
			ent->health = ent->max_health = 290;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 290;
			ent->client->ps.forcePowerMax = 129; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 2; 
		}
		break; 
		case LEVEL20:  
		{
			ent->health = ent->max_health = 300;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 300;
			ent->client->ps.forcePowerMax = 130; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 3; 
		}
		break; 
		case LEVEL21:  
		{
			ent->health = ent->max_health = 310;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 310;
			ent->client->ps.forcePowerMax = 131; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 3; 
		}
		break; 
		case LEVEL22:  
		{
			ent->health = ent->max_health = 320;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 320;
				ent->client->ps.forcePowerMax = 132; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 3; 
		}
		break; 
		case LEVEL23:  
		{
			ent->health = ent->max_health = 330;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 330;
				ent->client->ps.forcePowerMax = 133; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 3; 
		}
		break; 
		case LEVEL24:  
		{
			ent->health = ent->max_health = 340;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 340;
				ent->client->ps.forcePowerMax = 134; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 3; 
		}
		break; 
		case LEVEL25:  
		{
			ent->health = ent->max_health = 350;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 350;
				ent->client->ps.forcePowerMax = 135; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 3; 
		}
		break; 
		case LEVEL26:  
		{
			ent->health = ent->max_health = 360;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 360;
				ent->client->ps.forcePowerMax = 136; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 3; 
		}
		break; 
		case LEVEL27:  
		{
			ent->health = ent->max_health = 370;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 370;
			ent->client->ps.forcePowerMax = 137; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 3; 
		}
		break; 
		case LEVEL28:  
		{
			ent->health = ent->max_health = 380;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 380;
			ent->client->ps.forcePowerMax = 138; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 3; 
		}
		break; 
		case LEVEL29:  
		{
			ent->health = ent->max_health = 390;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 390;
			ent->client->ps.forcePowerMax = 139; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 3; 
		}
		break; 
		case LEVEL30:  
		{
			ent->health = ent->max_health = 400;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 400;
			ent->client->ps.forcePowerMax = 140; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 4; 
		}
		break; 
		case LEVEL31:  
		{
			ent->health = ent->max_health = 410;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 410;
			ent->client->ps.forcePowerMax = 141; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 4; 
		}
		break; 
		case LEVEL32:  
		{
			ent->health = ent->max_health = 420;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 420;
			ent->client->ps.forcePowerMax = 142; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 4; 
		}
		break; 
		case LEVEL33:  
		{
			ent->health = ent->max_health = 430;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 430;
			ent->client->ps.forcePowerMax = 143; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 4; 
		}
		break; 
		case LEVEL34:  
		{
			ent->health = ent->max_health = 440;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 440;
			ent->client->ps.forcePowerMax = 144; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 4; 
		}
		break; 
		case LEVEL35:  
		{
			ent->health = ent->max_health = 450;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 450;
			ent->client->ps.forcePowerMax = 145; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 4; 
		}
		break; 
		case LEVEL36:  
		{
			ent->health = ent->max_health = 460;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 460;
			ent->client->ps.forcePowerMax = 146; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 4; 
		}
		break; 
		case LEVEL37:  
		{
			ent->health = ent->max_health = 470;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 470;
			ent->client->ps.forcePowerMax = 147; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 4; 
		}
		break; 
		case LEVEL38:  
		{
			ent->health = ent->max_health = 480;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 480;
			ent->client->ps.forcePowerMax = 148; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 4; 
		}
		break; 
		case LEVEL39:  
		{
			ent->health = ent->max_health = 490;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 490;
			ent->client->ps.forcePowerMax = 149; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 4; 
		}
		break; 
		case LEVEL40:  
		{
			ent->health = ent->max_health = 500;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 500;
			ent->client->ps.forcePowerMax = 150; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 5; 
		}
		break; 
		case LEVEL41:  
		{
			ent->health = ent->max_health = 510;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 510;
			ent->client->ps.forcePowerMax = 151; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 5; 
		}
		break; 
		case LEVEL42:  
		{
			ent->health = ent->max_health = 520;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 520;
			ent->client->ps.forcePowerMax = 152; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 5; 
		}
		break; 
		case LEVEL43:  
		{
			ent->health = ent->max_health = 530;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 530;
			ent->client->ps.forcePowerMax = 153; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 5; 
		}
		break; 
		case LEVEL44:  
		{
			ent->health = ent->max_health = 540;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 540;
			ent->client->ps.forcePowerMax = 154; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 5; 
		}
		break; 
		case LEVEL45:  
		{
			ent->health = ent->max_health = 550;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 550;
			ent->client->ps.forcePowerMax = 155; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 5; 
		}
		break; 
		case LEVEL46:  
		{
			ent->health = ent->max_health = 560;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 560;
			ent->client->ps.forcePowerMax = 156; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 5; 
		}
		break; 
		case LEVEL47:  
		{
			ent->health = ent->max_health = 570;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 570;
			ent->client->ps.forcePowerMax = 157; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 5; 
		}
		break; 
		case LEVEL48:  
		{
			ent->health = ent->max_health = 580;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 580;
			ent->client->ps.forcePowerMax = 158; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 5; 
		}
		break; 
		case LEVEL49:  
		{
			ent->health = ent->max_health = 590;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 590;
			ent->client->ps.forcePowerMax = 159; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 5; 
		}
		break; 
		case LEVEL50:  
		{
			ent->health = ent->max_health = 600;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 600;
			ent->client->ps.forcePowerMax = 160; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 6; 
		}
		break; 
		case LEVEL51:  
		{
			ent->health = ent->max_health = 610;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 610;
			ent->client->ps.forcePowerMax = 161; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 6; 
		}
		break; 
		case LEVEL52:  
		{
			ent->health = ent->max_health = 620;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 620;
			ent->client->ps.forcePowerMax = 162; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 6; 
		}
		break; 
		case LEVEL53:  
		{
			ent->health = ent->max_health = 630;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 630;
			ent->client->ps.forcePowerMax = 163; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 6; 
		...
		case LEVEL54:  
		{
			ent->health = ent->max_health = 640;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 640;
			ent->client->ps.forcePowerMax = 164; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 6; 
		...
		case LEVEL55:  
		{
			ent->health = ent->max_health = 650;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 650;
			ent->client->ps.forcePowerMax = 165; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 6; 
		...
		case LEVEL56:  
		{
			ent->health = ent->max_health = 660;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 660;
			ent->client->ps.forcePowerMax = 166; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 6; 
		...
		case LEVEL57:  
		{
			ent->health = ent->max_health = 670;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 670;
			ent->client->ps.forcePowerMax = 167; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 6; 
		}
		break; 
		case LEVEL58:  
		{
			ent->health = ent->max_health = 680;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 680;
			ent->client->ps.forcePowerMax = 168; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 6; 
		...
		case LEVEL59:  
		{
			ent->health = ent->max_health = 690;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 690;
			ent->client->ps.forcePowerMax = 169; 
			ent->client->ps.forcePowerRegenRate = 100; 
			ent->client->ps.forcePowerRegenAmount = 6; 
		...
		case LEVEL60:  
		{
			ent->health = ent->max_health = 700;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 700;
			ent->client->ps.forcePowerMax = 170; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 7; 
		}
		break; 
		case LEVEL61:  
		{
			ent->health = ent->max_health = 710;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 710;
			ent->client->ps.forcePowerMax = 171; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 7; 
		...
		case LEVEL62:  
		{
			ent->health = ent->max_health = 720;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 720;
			ent->client->ps.forcePowerMax = 172; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 7; 
		...
		case LEVEL63:  
		{
			ent->health = ent->max_health = 730;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 730;
			ent->client->ps.forcePowerMax = 173; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 7; 
		...
		case LEVEL64:  
		{
			ent->health = ent->max_health = 740;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 740;
			ent->client->ps.forcePowerMax = 174; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 7; 
		...
		case LEVEL65:  
		{
			ent->health = ent->max_health = 750;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 750;
			ent->client->ps.forcePowerMax = 175; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 8; 
		
		}
		break; 
		case LEVEL66:  
		{
			ent->health = ent->max_health = 760;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 760;
			ent->client->ps.forcePowerMax = 176; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 8; 
		}
		break; 
		case LEVEL67:  
		{
			ent->health = ent->max_health = 770;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 770;
			ent->client->ps.forcePowerMax = 177; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 8; 
		}
		break; 
		case LEVEL68:  
		{
			ent->health = ent->max_health = 780;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 780;
			ent->client->ps.forcePowerMax = 178; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 8; 
		}
		break; 
		case LEVEL69:  
		{
			ent->health = ent->max_health = 790;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 790;
			ent->client->ps.forcePowerMax = 179; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 8; 
		}
		break; 
		case LEVEL70:  
		{
			ent->health = ent->max_health = 800;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 800;
			ent->client->ps.forcePowerMax = 180; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 9; 
		}
		break; 
		case LEVEL71:  
		{
			ent->health = ent->max_health = 810;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 810;
			ent->client->ps.forcePowerMax = 182; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 9; 
		}
		break; 
		case LEVEL72:  
		{
			ent->health = ent->max_health = 820;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 820;
			ent->client->ps.forcePowerMax = 184; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 9; 
		...
		case LEVEL73:  
		{
			ent->health = ent->max_health = 830;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 830;
			ent->client->ps.forcePowerMax = 186; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 9; 
		...
		case LEVEL74:  
		{
			ent->health = ent->max_health = 840;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 840;
			ent->client->ps.forcePowerMax = 188; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 9; 
		...
		case LEVEL75:  
		{
			ent->health = ent->max_health = 850;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 850;
			ent->client->ps.forcePowerMax = 190; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 10; 

		}
		break; 
		case LEVEL76:  
		{
			ent->health = ent->max_health = 860;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 860;
			ent->client->ps.forcePowerMax = 192; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 10; 
		...
		case LEVEL77:  
		{
			ent->health = ent->max_health = 870;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 870;
			ent->client->ps.forcePowerMax = 194; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 10; 
		...
		case LEVEL78:  
		{
			ent->health = ent->max_health = 880;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 880;
			ent->client->ps.forcePowerMax = 196; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 10; 
		}
		break; 
		case LEVEL79:  
		{
			ent->health = ent->max_health = 890;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 890;
				ent->client->ps.forcePowerMax = 198; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 10; 
		}
		break; 
		case LEVEL80:  
		{
			ent->health = ent->max_health = 900;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 900;
			ent->client->ps.forcePowerMax = 200; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 11; 

		}
		break; 
		case LEVEL81:  
		{
			ent->health = ent->max_health = 910;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 910;
			ent->client->ps.forcePowerMax = 220; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 11; 
		}
		break; 
		case LEVEL82:  
		{
			ent->health = ent->max_health = 920;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 920;
			ent->client->ps.forcePowerMax = 240; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 11; 
		}
		break; 
		case LEVEL83:  
		{
			ent->health = ent->max_health = 930;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 930;
			ent->client->ps.forcePowerMax = 260; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 11; 
		}
		break; 
		case LEVEL84:  
		{
			ent->health = ent->max_health = 940;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 940;
			ent->client->ps.forcePowerMax = 280; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 11; 
		}
		break; 
		case LEVEL85:  
		{
			ent->health = ent->max_health = 950;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 950;
			ent->client->ps.forcePowerMax = 300; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 12; 
		}
		break; 
		case LEVEL86:  
		{
			ent->health = ent->max_health = 960;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 960;
			ent->client->ps.forcePowerMax = 320; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 12; 
		}
		break; 
		case LEVEL87:  
		{
			ent->health = ent->max_health = 970;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 970;
			ent->client->ps.forcePowerMax = 340; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 12; 
		}
		break; 
		case LEVEL88:  
		{
			ent->health = ent->max_health = 980;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 980;
			ent->client->ps.forcePowerMax = 360; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 12; 
		}
		break; 
		case LEVEL89:  
		{
			ent->health = ent->max_health = 990;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 990;
			ent->client->ps.forcePowerMax = 380; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 12; 
		}
		break; 
		case LEVEL90: 
		{
			...
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 400; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 13; 
		}
		break; 
		case LEVEL91:
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 420; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 13; 
		}
		break; 
		case LEVEL92:
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 440; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 13; 
		}
		break; 
		case LEVEL93:
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 460; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 13; 
		}
		break; 
		case LEVEL94:
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 480; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 13; 
		}
		break; 
		case LEVEL95:
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 500; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 14; 
		}
		break; 
		case LEVEL96:
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 520; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 14; 
		}
		break; 
		case LEVEL97:
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 540; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 14; 
		}
		break; 
		case LEVEL98:
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 560; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 14; 
		}
		break; 
		case LEVEL99:
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 580; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 14; 
		}
		break; 
		case LEVEL100: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 600; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 15; 
		}
		break; 
		case LEVEL101: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 620; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 15; 
		}
		break; 
		case LEVEL102: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 640; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 15; 
		}
		break; 
		case LEVEL103: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 660; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 15; 
		}
		break; 
		case LEVEL104: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 680; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 15; 
		}
		break; 
		case LEVEL105: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 700; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 16; 
		}
		break; 
		case LEVEL106: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 720; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 16; 
		}
		break; 
		case LEVEL107: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 740; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 16; 
		}
		break; 
		case LEVEL108: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 760; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 16; 
		}
		break; 
		case LEVEL109: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 780; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 16; 
		}
		break; 
		case LEVEL110: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 800; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 17; 
		}
		break; 
		case LEVEL111: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 820; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 17; 
		}
		break; 
		...
		case LEVEL112: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 840; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 17; 
		}
		break; 
		...
		case LEVEL113: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 860; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 17; 
		}
		break; 
		...
		case LEVEL114: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 880; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 17; 
		}
		break; 
		case LEVEL115: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 900; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 18; 
		}
		break; 
		case LEVEL116: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 920; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 18; 
		}
		break; 
		case LEVEL117: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 940; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 18; 
		}
		break; 
		case LEVEL118: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 960; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 18; 
		}
		break; 
		case LEVEL119: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 980; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 19; 
		}
		break; 
		case LEVEL120: 
		{
			ent->health = ent->max_health = 1000;
			ent->client->ps.stats[STAT_HEALTH] = ent->client->ps.stats[STAT_MAX_HEALTH] = 1000;
			ent->client->ps.forcePowerMax = 1000; 
			ent->client->ps.forcePowerRegenRate = 150; 
			ent->client->ps.forcePowerRegenAmount = 20; 
		}
		break;
	}
}
...
Q3_SetPlayerArmor
  ...
  Return type	: static void 
  Argument		:  int entID
  Argument		: const char *PlayerArmorName
============
*/
static void Q3_SetPlayerArmor ( int entID, const char *PlayerArmorName )
{
	gentity_t	*ent  = &g_entities[entID];

	if ( !ent )
	{
		Quake3Game()->DebugPrint( IGameInterface::WL_WARNING, "Q3_SetPlayerArmor: invalid entID %d\n", entID);
		return;
	}

	if ( !ent->client )
	{
		Quake3Game()->DebugPrint( IGameInterface::WL_ERROR, "Q3_SetPlayerArmor: ent %d is NOT a player!\n", entID);
		return;
	}
	// 1 -Assign the level to player 
	ent->client->ARMORLEVEL = (Armor_t)GetIDForString( ArmorTable, PlayerArmorName ); 
	//ent->client->ls.PlayerLevel[NUM_LEVELS] = (Level_t)GetIDForString( LevelTable, PlayerLevelName );
	...
	// NOW CAP AND SET THE PLAYER ARMOR in relation of the amount of level. 
	...
	ent->armor = ent->max_armor = max;
	switch ( ent->client->ARMORLEVEL )
	{
		case ARMOR_NONE:  
		{
			ent->armor = ent->max_armor = 0;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 0;
		}
		break; 
		case ARMOR1:  
		{
			ent->armor = ent->max_armor = 100;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 100;
		}
		break; 
		case ARMOR2:  
		{
			ent->armor = ent->max_armor = 120;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 120;
	
		}
		break; 
		case ARMOR3:  
		{
			ent->armor = ent->max_armor = 150;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 150;
		}
		break; 
		case ARMOR4:  
		{
			ent->armor = ent->max_armor = 200;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 200;
	
		}
		break; 
		case ARMOR5:  
		{
			ent->armor = ent->max_armor = 250;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 250;
		}
		break; 
		case ARMOR6:  
		{
			ent->armor = ent->max_armor = 300;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 300;
		}
		break; 
		case ARMOR7:  
		{
			ent->armor = ent->max_armor = 350;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 350;
	
		}
		break; 
		case ARMOR8:  
		{
			ent->armor = ent->max_armor = 400;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 400;
		}
		break; 
		case ARMOR9:  
		{
			ent->armor = ent->max_armor = 450;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 450;
	
		}
		break; 
		case ARMOR10:  
		{
			ent->armor = ent->max_armor = 500;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 500;
		}
		break; 
		case ARMOR11:  
		{
			ent->armor = ent->max_armor = 550;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 550;
		}
		break; 
		case ARMOR12:  
		{
			ent->armor = ent->max_armor = 600;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 600;
	
		}
		break; 
		case ARMOR13:  
		{
			ent->armor = ent->max_armor = 650;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 650;
		}
		break; 
		case ARMOR14:  
		{
			ent->armor = ent->max_armor = 700;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 700;
		...
		case ARMOR15:  
		{
			ent->armor = ent->max_armor = 750;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 750;
		}
		break; 
		case ARMOR16:  
		{
			ent->armor = ent->max_armor = 800;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 800;
		}
		break; 
		case ARMOR17:  
		{
			ent->armor = ent->max_armor = 850;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 850;
	
		}
		break; 
		case ARMOR18:  
		{
			ent->armor = ent->max_armor = 900;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 900;
		}
		break; 
		case ARMOR19:  
		{
			ent->armor = ent->max_armor = 950;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 950;
	
		}
		break; 
		case ARMOR20:  
		{
			ent->armor = ent->max_armor = 999;
			ent->client->ps.stats[STAT_ARMOR] = ent->client->ps.stats[STAT_MAX_ARMOR] = 999;
		}
		break; 
	}
}
...
//		//can never be set
	...
	case SET_PLAYER_LEVEL: 
		int_data = atoi((char *) data);
		Q3_SetPlayerLevel( entID, (char *) data );
		break;
	case SET_PLAYER_ARMOR: 
		int_data = atoi((char *) data);
		Q3_SetPlayerArmor( entID, (char *) data );
		break;
	...
	case SET_FORCE_HEALOTHER_LEVEL:
	case SET_FORCE_WRACK_LEVEL: 
	case SET_FORCE_GLYPH_LEVEL: 
	case SET_STONE_GLYPH_LEVEL:
	case SET_SOUND_GLYPH_LEVEL:
	case SET_WATER_GLYPH_LEVEL:
	case SET_FIRE_GLYPH_LEVEL:
	case SET_SUN_GLYPH_LEVEL:
	case SET_WIND_GLYPH_LEVEL: 
	case SET_HOLY_GLYPH_LEVEL: 
	case SET_DARK_GLYPH_LEVEL: 
	case SET_NECRO_GLYPH_LEVEL: 
	...
	case SET_GUN1:
	case SET_GUN2:
		WP_SetGun( &g_entities[entID], toSet-SET_GUN1, (char *)data );
		break;
...
extern void Saboteur_Cloak( gentity_t *self );
	...
	case SET_FORCE_MIND_TRICK:
		...
		break;
	case SET_FORCE_STUN:
		Q3_SetForcePower( entID, FP_STUN, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_FORCE_HATE:
		Q3_SetForcePower( entID, FP_HATE, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	...
	case SET_FORCE_FREEZE:
		...
		break;
	case SET_FORCE_HEALOTHER:
		Q3_SetForcePower( entID, FP_HEALOTHER, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_FORCE_WRACK:
		Q3_SetForcePower( entID, FP_WRACK, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_FORCE_GLYPH:
		Q3_SetForcePower( entID, FP_FORCEGLYPH, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_STONE_GLYPH:
		Q3_SetForcePower( entID, FP_STONEGLYPH, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_SOUND_GLYPH:
		Q3_SetForcePower( entID, FP_SOUNDGLYPH, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_WATER_GLYPH:
		Q3_SetForcePower( entID, FP_WATERGLYPH, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_FIRE_GLYPH:
		Q3_SetForcePower( entID, FP_FIREGLYPH, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_SUN_GLYPH:
		Q3_SetForcePower( entID, FP_SUNGLYPH, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_WIND_GLYPH:
		Q3_SetForcePower( entID, FP_WINDGLYPH, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_HOLY_GLYPH:
		Q3_SetForcePower( entID, FP_HOLYGLYPH, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_DARK_GLYPH:
		Q3_SetForcePower( entID, FP_DARKGLYPH, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_NECRO_GLYPH:
		Q3_SetForcePower( entID, FP_NECROGLYPH, (qboolean)(Q_stricmp("true",(char*)data)==0) );
		break;
	case SET_FORCE_GRIP:
