...
struct BuffCanceling_t
{
	...
	std::vector<OtherBuffCancel_t> other;
};
...
struct Buff_t
{
	...
	BuffCanceling_t	cancel;
	BuffDamage_t		damage;
	BuffVisuals_t	visuals;
	BuffPassive_t	passive;
};
