...
typedef enum //# setType_e
{
	...
	SET_GUN1,//## %s="none" # Name of a gun in *.GUN file to use for character. "none" removes current gun
	SET_GUN2,//## %s="none" # Name of a gun in *.GUN file to use for character. "none" removes current gun
	...
	SET_FACESMILE,		// smiling
	SET_FACEGLAD,		// glad
	SET_FACEHAPPY,		// happy
	SET_FACESHOCKED,	// shocked
	...
	SET_FORCE_HEALOTHER,//## %t="BOOL_TYPES" # This NPC/player will not have any bone angle overrides or pitch or roll (should only be used in cinematics)
	SET_FORCE_WRACK,//## %t="BOOL_TYPES" # This NPC/player will not have any bone angle overrides or pitch or roll (should only be used in cinematics)
	SET_FORCE_GLYPH,//## %t="BOOL_TYPES" # Causes this ent to start force draining their enemy at whatever level of force drain they have (will drain until scripted to stop)
	SET_STONE_GLYPH,//## %t="BOOL_TYPES" # Causes this ent to start force draining their enemy at whatever level of force drain they have (will drain until scripted to stop)
	SET_SOUND_GLYPH,//## %t="BOOL_TYPES" # Causes this ent to start force draining their enemy at whatever level of force drain they have (will drain until scripted to stop)
	SET_WATER_GLYPH,//## %t="BOOL_TYPES" # Causes this ent to start force draining their enemy at whatever level of force drain they have (will drain until scripted to stop)
	SET_FIRE_GLYPH,//## %t="BOOL_TYPES" # Causes this ent to start force draining their enemy at whatever level of force drain they have (will drain until scripted to stop)
	SET_SUN_GLYPH,//## %t="BOOL_TYPES" # This NPC/player will not have any bone angle overrides or pitch or roll (should only be used in cinematics)
	SET_WIND_GLYPH,//## %t="BOOL_TYPES" # This NPC/player will not have any bone angle overrides or pitch or roll (should only be used in cinematics)
	SET_HOLY_GLYPH,//## %t="BOOL_TYPES" # This NPC/player will not have any bone angle overrides or pitch or roll (should only be used in cinematics)
	SET_DARK_GLYPH,//## %t="BOOL_TYPES" # This NPC/player will not have any bone angle overrides or pitch or roll (should only be used in cinematics)
	SET_NECRO_GLYPH,//## %t="BOOL_TYPES" # This NPC/player will not have any bone angle overrides or pitch or roll (should only be used in cinematics)
...
*/
	...
	// NEW STUFF SCRIPT SUPPORT FOR ASTROFANTASY PROJECT. 
	SET_PLAYER_LEVEL, // ## %t="LEVELS" # Change Player Level 
	SET_PLAYER_ARMOR, //## %t="ARMORS" # Change Player Armor Amount 
	SET_WORLD, // ## change world_t of entity, affecting gravity for player. that affect his UI scheme. 
	SET_CLASS, // ## change class_t of Entity
	SET_FORCE_STUN_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_FORCE_HATE_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_FORCE_CONTROLMIND_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_FORCE_FREEZE_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_FORCE_HEALOTHER_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_FORCE_WRACK_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_FORCE_GLYPH_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_STONE_GLYPH_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_SOUND_GLYPH_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_WATER_GLYPH_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_FIRE_GLYPH_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_SUN_GLYPH_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_WIND_GLYPH_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_HOLY_GLYPH_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_DARK_GLYPH_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
	SET_NECRO_GLYPH_LEVEL,//## %t="FORCE_LEVELS" # Change force power level
