...
void P_WorldEffects( gentity_t *ent ) {
	...
	if ( (mouthContents&(CONTENTS_WATER|CONTENTS_SLIME)) ) 
	{
		...
		if ( // Rahabim 
			ent->client->NPC_class == CLASS_SWAMPTROOPER || ent->client->NPC_class == CLASS_ALORA ||
			ent->client->NPC_class == CLASS_FISH || 
			// Only if they get water resistance 
			ent->client->NPC_class == CLASS_KYLE || 	ent->client->NPC_class == CLASS_KAIN ||
			ent->client->NPC_class == CLASS_LUKE || ent->client->NPC_class == CLASS_JEDI 
			|| ent->client->NPC_class == CLASS_SABOTEUR ||	ent->client->NPC_class == CLASS_BESPIN_COP || 
			ent->client->NPC_class == CLASS_SHADOWTROOPER || ent->client->NPC_class == CLASS_PROTOCOL || 
			ent->client->NPC_class == CLASS_ASSASSIN_DROID || ent->client->NPC_class == CLASS_SABER_DROID 
			||	ent->client->NPC_class == CLASS_MORGANKATARN || ent->client->NPC_class == CLASS_PROBE ||
			ent->client->NPC_class == CLASS_REBEL || ent->client->NPC_class == CLASS_ROCKETTROOPER ||
			ent->client->NPC_class == CLASS_BOBAFETT ||	ent->client->NPC_class == CLASS_BARTENDER || 
			ent->client->NPC_class == CLASS_GALAKMECH || ent->client->NPC_class == CLASS_GONK || 
			ent->client->NPC_class == CLASS_HOWLER || ent->client->NPC_class == CLASS_R2D2 ||	
			ent->client->NPC_class == CLASS_R5D2 || ent->client->NPC_class == CLASS_MARK1 ||
			ent->client->NPC_class == CLASS_SEEKER || ent->client->NPC_class == CLASS_MARK2 
			|| ent->client->NPC_class == CLASS_REMOTE ||	ent->client->NPC_class == CLASS_SENTRY 
			|| ent->client->NPC_class == CLASS_MOUSE || 	ent->client->NPC_class == CLASS_ATST || 
			ent->client->NPC_class == CLASS_MINEMONSTER || ent->client->NPC_class == CLASS_KYLE ||	ent->client->NPC_class == CLASS_REELO
			|| ent->client->NPC_class == CLASS_WAMPA || ent->client->NPC_class == CLASS_TAVION || 
			ent->client->NPC_class == CLASS_DESANN || 
			// New classes 			
			ent->client->NPC_class == CLASS_RAZIEL ||	ent->client->NPC_class == CLASS_HOLY || 
			ent->client->NPC_class == CLASS_MENTALIST || ent->client->NPC_class == CLASS_DRUIDREAVER || 
			ent->client->NPC_class == CLASS_LANDO || ent->client->NPC_class == CLASS_NECROREAVER ||	
			ent->client->NPC_class == CLASS_DARKREAVER || ent->client->NPC_class == CLASS_TANKREAVER ||
			ent->client->NPC_class == CLASS_LIGHTREAVER || ent->client->NPC_class == CLASS_FIREREAVER 
			|| ent->client->NPC_class == CLASS_ICEREAVER ||	ent->client->NPC_class == CLASS_SPIDERREAVER || 
			ent->client->NPC_class == CLASS_SPIDERREAVER2 || ent->client->NPC_class == CLASS_SPIDERREAVER3 || 
			ent->client->NPC_class == CLASS_EARTHREAVER ||
			
			ent->client->NPC_class == CLASS_DARK || ent->client->NPC_class == CLASS_POLTER ||
			ent->client->NPC_class == CLASS_IVY || ent->client->NPC_class == CLASS_CRYSTAL || 
			ent->client->NPC_class == CLASS_EARTH ||	ent->client->NPC_class == CLASS_SONIC || 
			ent->client->NPC_class == CLASS_LIGHT || ent->client->NPC_class == CLASS_WATER ||
			ent->client->NPC_class == CLASS_AIR || ent->client->NPC_class == CLASS_CRYSTAL || 
			ent->client->NPC_class == CLASS_NECRO ||	ent->client->NPC_class == CLASS_SONIC || 
			ent->client->NPC_class == CLASS_SHARK || 	ent->client->NPC_class == CLASS_RANCOR || 
			ent->client->NPC_class == CLASS_JAWA || ent->client->NPC_class == CLASS_REAPER ||	ent->client->NPC_class == CLASS_DREADNOUGHT || 
			ent->client->NPC_class == CLASS_GHOST || ent->client->NPC_class == CLASS_VAMPIRE_GHOST || 
			ent->client->NPC_class == CLASS_COMMANDO || ent->client->NPC_class == CLASS_MURJJ ||
			ent->client->NPC_class == CLASS_THRALL || ent->client->NPC_class == CLASS_NECRO ||
			ent->client->NPC_class == CLASS_DEMON_FIRE || ent->client->NPC_class == CLASS_DEMON_POISON 
			|| ent->client->NPC_class == CLASS_DEMON_BLADE ||	ent->client->NPC_class == CLASS_DEMON_ELECTRO || 
			ent->client->NPC_class == CLASS_HYLDEN || ent->client->NPC_class == CLASS_TENTACLE ||			
			ent->client->NPC_class == CLASS_ELDERGOD ||
			ent->client->NPC_class == CLASS_VAMPIRE_DEMON )
			// These classes cannot drown on water
		{//they have air tanks
			ent->client->airOutTime = level.time + 12000;	// don't need air
			ent->damage = 2;
		}
		...
		{// if out of air, start drowning
			// drown!
			// QUA ADDA CHE SOLO LE CLASSI UMANE E ANIMALI POSSONO ANNEGARE
			// ARRIVATO QUI 
			if ( ent->client->NPC_class == CLASS_PRISONER ||
				...
				// Resistono nell'Alleanza: Soul, Sheer, Kainh, Samahel, Osil, Shaar Naik, Phobos 
				ent->client->NPC_class == CLASS_VAMPIRE_FEAR || // poi diventa immune
				...
				ent->client->NPC_class == CLASS_VAMPIRE_ELF2 || // la 3 è immune 
				...
				// Le corrispettive bat e wolf form di queste classi sono deboli all'acqua. 
				ent->client->NPC_class == CLASS_WOLFFORM ||
				ent->client->NPC_class == CLASS_WOLFKAIN ||
				ent->client->NPC_class == CLASS_WOLFKAIN2 || 
				ent->client->NPC_class == CLASS_WOLFVORADOR || 
				ent->client->NPC_class == CLASS_WOLFJANOS ||
				ent->client->NPC_class == CLASS_WOLFVAMPIRE_FEAR ||
				ent->client->NPC_class == CLASS_WOLFVAMPIRE_LYCAN ||
				ent->client->NPC_class == CLASS_WOLFVAMPIRE_ELF || 
				ent->client->NPC_class == CLASS_LIONVAMPIRE_ELF ||
				ent->client->NPC_class == CLASS_ESKANDOR || 
				ent->client->NPC_class == CLASS_BATFORM ||
				ent->client->NPC_class == CLASS_BATKAIN ||
				ent->client->NPC_class == CLASS_BATKAIN2 || 
				ent->client->NPC_class == CLASS_BATVORADOR || 
				ent->client->NPC_class == CLASS_BATVAMPIRE_FEAR ||
				ent->client->NPC_class == CLASS_BATVAMPIRE_ELF || 
				ent->client->NPC_class == CLASS_BATVAMPIRE_ELF2 ) 
			{
			...
			if ( ent->health > 0 ) {
				...
				// This ONLY FOR CLASS THAT NEED TO BREATH! 
	...
	if ((ent->client->poisonDamage) && (ent->client->poisonTime < level.time))
	{
		...
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_POISON );//FIXME: MOD_POISON?
	...
	// Drained by vampires?
	if ((ent->client->drainDamage) && (ent->client->drainTime < level.time))
	{
		ent->client->drainDamage -= 2;
		ent->client->drainTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_FORCE_DRAIN );//FIXME: MOD_POISON?

		if (ent->client->drainDamage<0)
		{
			ent->client->drainDamage = 0;
		}
	}

	// Burning for fire. 
	if ((ent->client->fireDamage) && (ent->client->fireTime < level.time))
	{
		ent->client->fireDamage -= 2;
		ent->client->fireTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_BLASTER );//FIXME: MOD_POISON?

		if (ent->client->fireDamage<0)
		{
			ent->client->fireDamage = 0;
		}
	}

	// Chocked by smoke! 
	if ((ent->client->smokeDamage) && (ent->client->smokeTime < level.time))
	{
		ent->client->smokeDamage -= 2;
		ent->client->smokeTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_BRYAR );//FIXME: MOD_POISON?

		if (ent->client->smokeDamage<0)
		{
			ent->client->smokeDamage = 0;
		}
		if (ent->health > 0)
	...
	// sucked by void! 
	if ((ent->client->voidDamage) && (ent->client->voidTime < level.time))
	{
		ent->client->voidDamage -= 2;
		ent->client->voidTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_BRYAR_ALT );//FIXME: MOD_POISON?

		if (ent->client->voidDamage<0)
		{
			ent->client->voidDamage = 0;
		}
		if (ent->health > 0)
		{ //did that last one kill them?
			//play the choking sound
	...
	// light damage. 
	if ((ent->client->lightDamage) && (ent->client->lightTime < level.time))
	{
		ent->client->lightDamage -= 2;
		ent->client->lightTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_BOWCASTER );//FIXME: MOD_POISON?

		if (ent->client->lightDamage<0)
		{
			ent->client->lightDamage = 0;
		}
	}

	// shock damage. 
	if ((ent->client->shockDamage) && (ent->client->shockTime < level.time))
	{
		ent->client->shockDamage -= 2;
		ent->client->shockTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_ELECTROCUTE );//FIXME: MOD_POISON?

		if (ent->client->shockDamage<0)
		{
			ent->client->shockDamage = 0;
		}
		if (  ent && ent->client ) 
			{
			  ent->s.powerups |= ( 1 << PW_SHOCKED );
			  ent->client->ps.powerups[PW_SHOCKED] = cg.time + 1000;

		}
	}
	// sun damage. 
	if ((ent->client->sunDamage) && (ent->client->sunTime < level.time))
	{
		ent->client->sunDamage -= 2;
		ent->client->sunTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_SNIPER );//FIXME: MOD_POISON?

		if (ent->client->sunDamage<0)
		{
			ent->client->sunDamage = 0;
		}
		if (  ent && ent->client ) 
			{
			  ent->s.powerups |= ( 1 << PW_SHOCKED );
		...
		if (  ent &&  ent->client && ent->health <= 0 )
						{
							...
							if ( ent->ghoul2.size() && other->headBolt != -1 )
							{//FIXME: what if already playing effect?
								G_PlayEffect( G_EffectIndex( "bowcastet3/disintegration" ), ent->playerModel, ent->chestBolt, ent->s.number, ent->currentOrigin ); // same effect, more huge, for disintegration of disruptor  - death_smoke
							}
						}
		*/
	...
	// "lava" dmg. 
	if ((ent->client->lavaDamage) && (ent->client->lavaTime < level.time))
	{
		ent->client->lavaDamage -= 2;
		ent->client->lavaTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_BLASTER_ALT );//FIXME: MOD_POISON?

		if (ent->client->lavaDamage<0)
		{
			ent->client->lavaDamage = 0;
		}
		if (  ent &&  ent->client && ent->health <= 0 )
					{
						 ent->s.powerups |= ( 1 << PW_DISRUPTION );
						 ...
						 if ( ent->ghoul2.size() && ent->headBolt != -1 )
							{//FIXME: what if already playing effect?
								G_PlayEffect( G_EffectIndex( "blaster3/disintegration" ), ent->playerModel, ent->chestBolt, ent->s.number, ent->currentOrigin ); // same effect, more huge, for disintegration 
							}
					}
	}

	// wind damage  
	if ((ent->client->windDamage) && (ent->client->windTime < level.time))
	{
		ent->client->windDamage -= 2;
		ent->client->windTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_ROCKET );//FIXME: MOD_POISON?

		if (ent->client->windDamage<0)
		{
			ent->client->windDamage = 0;
		}
	}

	// storm damage  
	if ((ent->client->stormDamage) && (ent->client->stormTime < level.time))
	{
		ent->client->stormDamage -= 2;
		ent->client->stormTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_ROCKET_ALT );//FIXME: MOD_POISON?

		if (ent->client->stormDamage<0)
		{
			ent->client->stormDamage = 0;
		}
		if (  ent && ent->client ) 
			{
			  ent->s.powerups |= ( 1 << PW_SHOCKED );
	...
	// water  
	if ((ent->client->waterDamage) && (ent->client->waterTime < level.time))
	{
		ent->client->waterDamage -= 2;
		ent->client->waterTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_REPEATER );//FIXME: MOD_POISON?

		if (ent->client->waterDamage<0)
		{
			ent->client->waterDamage = 0;
		}
	}

	// ice damage  
	if ((ent->client->iceDamage) && (ent->client->iceTime < level.time))
	{
		ent->client->iceDamage -= 2;
		ent->client->iceTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_REPEATER_ALT );//FIXME: MOD_POISON?

		if (ent->client->iceDamage<0)
		{
			ent->client->iceDamage = 0;
		}
	}

	// crystal damage  
	if ((ent->client->crystalDamage) && (ent->client->crystalTime < level.time))
	{
		ent->client->crystalDamage -= 2;
		ent->client->crystalTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_REPEATER_ALT );//FIXME: MOD_POISON?
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_FLECHETTE );//FIXME: MOD_POISON?
		
		if (ent->client->crystalDamage<0)
		{
			ent->client->crystalDamage = 0;
		}
	}
	// acid dmg. 
	if ((ent->client->acidDamage) && (ent->client->acidTime < level.time))
	{
		ent->client->acidDamage -= 2;
		ent->client->acidTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_SLIME );//FIXME: MOD_POISON?

		if (ent->client->acidDamage<0)
		{
			ent->client->acidDamage = 0;
		}
		if (  ent &&  ent->client && ent->health <= 0 )
						{
							ent->s.powerups |= ( 1 << PW_DISRUPTION );
							...
							if ( ent->ghoul2.size() && ent->headBolt != -1 )
							{//FIXME: what if already playing effect?
								G_PlayEffect( G_EffectIndex( "acid/disintegration" ), ent->playerModel, ent->chestBolt, ent->s.number, ent->currentOrigin ); // same effect, more huge, for disintegration 
							}
						}
	...
	// alchemic dmg 
	if ((ent->client->alchDamage) && (ent->client->alchTime < level.time))
	{
		ent->client->alchDamage -= 2;
		ent->client->alchTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_ALCHEMIC_ALT );//FIXME: MOD_POISON?

		if (ent->client->alchDamage<0)
		{
			ent->client->alchDamage = 0;
		}
		if (  ent &&  ent->client && ent->health <= 0 )
						{
							ent->s.powerups |= ( 1 << PW_DISRUPTION );
							...
							if ( ent->ghoul2.size() && ent->headBolt != -1 )
							{//FIXME: what if already playing effect?
								G_PlayEffect( G_EffectIndex( "putrescence/disintegration" ), ent->playerModel, ent->chestBolt, ent->s.number, ent->currentOrigin ); // same effect, more huge, for disintegration 					}
							}
						}
	}
	// stone damage  
	if ((ent->client->stoneDamage) && (ent->client->stoneTime < level.time))
	{
		ent->client->stoneDamage -= 2;
		ent->client->stoneTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_FLECHETTE_ALT );//FIXME: MOD_POISON?

		if (ent->client->stoneDamage<0)
		{
			ent->client->stoneDamage = 0;
		}
	}

	// holy dmg. 
	if ((ent->client->holyDamage) && (ent->client->holyTime < level.time))
	{
		ent->client->holyDamage -= 2;
		ent->client->holyTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_DEMP2 );//FIXME: MOD_POISON?

		if (ent->client->holyDamage<0)
		{
			ent->client->holyDamage = 0;
		}
	}
	// nature \ life dmg  
	if ((ent->client->natureDamage) && (ent->client->natureTime < level.time))
	{
		ent->client->natureDamage -= 2;
		ent->client->natureTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_DEMP2_ALT );//FIXME: MOD_POISON?

		if (ent->client->natureDamage<0)
		{
			ent->client->natureDamage = 0;
		}
	}

	// necromancy dmg  
	if ((ent->client->necroDamage) && (ent->client->necroTime < level.time))
	{
		ent->client->necroDamage -= 2;
		ent->client->necroTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_CONC );//FIXME: MOD_POISON?

		if (ent->client->necroDamage<0)
		{
			ent->client->necroDamage = 0;
		}
	}
	// hellfire damage  
	if ((ent->client->hellDamage) && (ent->client->hellTime < level.time))
	{
		ent->client->hellDamage -= 2;
		ent->client->hellTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_BLASTER );//FIXME: MOD_POISON?
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_EMPLACED );//FIXME: MOD_POISON?

		if (ent->client->hellDamage<0)
		{
			ent->client->hellDamage = 0;
		}
		if (  ent &&  ent->client && ent->health <= 0 )
						{
							ent->s.powerups |= ( 1 << PW_DISRUPTION );
							...
							if ( ent->ghoul2.size() && ent->headBolt != -1 )
							{//FIXME: what if already playing effect?
								G_PlayEffect( G_EffectIndex( "fire_hell/disintegration" ), ent->playerModel, ent->chestBolt, ent->s.number, ent->currentOrigin ); // same effect, more huge, for disintegration 
							}
						}

	}

	// green fire damage - hylden damage. 
	if ((ent->client->hyldenDamage) && (ent->client->hyldenTime < level.time))
	{
		ent->client->hyldenDamage -= 2;
		ent->client->hyldenTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_EMPLACED );//FIXME: MOD_POISON?
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_POISON );//FIXME: MOD_POISON?

		if (ent->client->hyldenDamage<0)
		{
			ent->client->hyldenDamage = 0;
		}
		...
		if (  ent &&  ent->client && ent->health <= 0 )
						{
							...
							if ( ent->ghoul2.size() && ent->headBolt != -1 )
							{//FIXME: what if already playing effect?
								G_PlayEffect( G_EffectIndex( "fire_green/disintegration" ), ent->playerModel, ent->chestBolt, ent->s.number, ent->currentOrigin ); // same effect, more huge, for disintegration 
							}
						}
	}

	// green lightning damage  
	if ((ent->client->hyldenShockDamage) && (ent->client->hyldenShockTime < level.time))
	{
		ent->client->hyldenShockDamage -= 2;
		ent->client->hyldenShockTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_EMPLACED );//FIXME: MOD_POISON?
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_FORCE_LIGHTNING );//FIXME: MOD_POISON?

		if (ent->client->hyldenShockDamage<0)
		{
			ent->client->hyldenShockDamage = 0;
		}
		if (  ent && ent->client ) 
			{
			  ent->s.powerups |= ( 1 << PW_SHOCKED );
		...
		if (  ent &&  ent->client && ent->health <= 0 )
					...
					if ( ent->ghoul2.size() && ent->headBolt != -1 )
						{//FIXME: what if already playing effect?
							G_PlayEffect( G_EffectIndex( "emplaced/disintegration" ), ent->playerModel, ent->chestBolt, ent->s.number, ent->currentOrigin ); // same effect, more huge, for disintegration }
						}
	}

	// Sonic damage  
	if ((ent->client->sonicDamage) && (ent->client->sonicTime < level.time))
	{
		ent->client->sonicDamage -= 2;
		ent->client->sonicTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, 2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_SONIC );//FIXME: MOD_POISON?

		if (ent->client->sonicDamage<0)
		{
			ent->client->sonicDamage = 0;
		}
	}
	
	// healed?
	if ((ent->client->healPoints) && (ent->client->healTime < level.time))
	{
		ent->client->healPoints += 2;
		ent->client->healTime = level.time + 1000;
		G_Damage( ent, NULL, NULL, 0, 0, -2, DAMAGE_NO_KNOCKBACK|DAMAGE_NO_ARMOR, MOD_UNKNOWN );//FIXME: MOD_POISON?

		if (ent->client->healPoints<0 )
		{
			ent->client->healPoints = 0;
		}
	}
...
void G_MatchPlayerWeapon( gentity_t *ent )
{
	...
	{//player is around
		...
		if ( newWeap != WP_NONE && ent->client->ps.weapon != newWeap )
		{
			...
			else if ( newWeap == WP_BLASTER_PISTOL )
			{
				//FIXME: AddSound/Sight Event
				int numGuns = WP_GunInitData( ent );
				WP_GunAddG2GunModels( ent );
				for ( int GunNum = 0; GunNum < numGuns; GunNum++ )
				{
					ent->client->gs.gun[GunNum].Gun_Model = g_entities[0].client->gs.gun[GunNum].Gun_Model;
				}
			}
			else
			{
...
extern void ForceHealOther(gentity_t *ent);
extern void ForceWrack(gentity_t *ent);
extern void ForceAbsorb(gentity_t *ent);
extern void ForceHeal(gentity_t *ent);
extern void ForceGlyph(gentity_t *ent);
extern void StoneGlyph(gentity_t *ent);
extern void SoundGlyph(gentity_t *ent);
extern void WaterGlyph(gentity_t *ent);
extern void FireGlyph(gentity_t *ent);
extern void SunGlyph(gentity_t *ent);
extern void WindGlyph(gentity_t *ent);
extern void HolyGlyph(gentity_t *ent);
extern void DarkGlyph(gentity_t *ent);
extern void NecroGlyph(gentity_t *ent);
static void ProcessGenericCmd(gentity_t *ent, byte cmd)
{
	...
	case GENCMD_FORCE_HEAL:
		ForceHeal(ent);
		break;
	case GENCMD_FORCE_GLYPH:
		ForceGlyph(ent);
		break;
	case GENCMD_STONE_GLYPH:
		StoneGlyph(ent);
		break;
	case GENCMD_SOUND_GLYPH:
		SoundGlyph(ent);
		break;
	case GENCMD_WATER_GLYPH:
		WaterGlyph(ent);
		break;
	case GENCMD_FIRE_GLYPH:
		FireGlyph(ent);
		break;
	case GENCMD_SUN_GLYPH:
		SunGlyph(ent);
		break;
	case GENCMD_WIND_GLYPH:
		WindGlyph(ent);
		break;
	case GENCMD_HOLY_GLYPH:
		HolyGlyph(ent);
		break;
	case GENCMD_DARK_GLYPH:
		DarkGlyph(ent);
		break;
	case GENCMD_NECRO_GLYPH:
		NecroGlyph(ent);
		break;
	...
	if ( ent->s.number<MAX_CLIENTS )
	{
		...
		{//you're controlling another NPC
			...
			if ( controlled->NPC 
				...
				controlled->NPC && controlled->NPC->controlledTime 
				&& ent->client->ps.forcePowerLevel[FP_WRACK] > FORCE_LEVEL_0
				)
