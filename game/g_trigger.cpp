...
// BAT, BIRD, MIST
			other->client->NPC_class == CLASS_BIRD ||
			other->client->NPC_class == CLASS_POLTER ||
			other->client->NPC_class == CLASS_REAPER || 
			other->client->NPC_class == CLASS_ARIEL ||
			other->client->NPC_class == CLASS_VAMPIRE_GHOST || 
			other->client->NPC_class == CLASS_BATFORM ||
			other->client->NPC_class == CLASS_BATKAIN ||
			other->client->NPC_class == CLASS_BATKAIN2 ||
			other->client->NPC_class == CLASS_BATKAIN3 ||
			other->client->NPC_class == CLASS_BATVORADOR ||
			other->client->NPC_class == CLASS_BATVAMPIRE_QUEEN ||
			other->client->NPC_class == CLASS_BATNECROMANCER ||
			other->client->NPC_class == CLASS_BATVAMPIRE_WATER ||
			other->client->NPC_class == CLASS_BATVAMPIRE_ELF ||
			other->client->NPC_class == CLASS_BATVAMPIRE_ELF2 ||
			other->client->NPC_class == CLASS_BATVAMPIRE_ELF3 || 
			other->client->NPC_class == CLASS_HELLBAT ||
			other->client->NPC_class == CLASS_BATVAMPIRE_FEAR ||
			other->client->NPC_class == CLASS_BATVAMPIRE_FEAR2 ||
			other->client->NPC_class == CLASS_JANOS ||
			other->client->NPC_class == CLASS_KAIN3 ))
