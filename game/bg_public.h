...
//END JKA weapons
	...
	// NEW EVENTS FOR BLACK MAGIC
	EV_BLACKFIRE_ALT_MISS,
	EV_SONIC_ALT_MISS,
	EV_IMMOLATION_ALT_MISS,
	EV_HOLYIMMOLATION_ALT_MISS, 
	EV_SD_ALT_MISS,
	EV_MIND_ALT_MISS,
	EV_DIM_ALT_MISS,
	EV_CONFLICT_ALT_MISS, 
	EV_NATURE_ALT_MISS,
	EV_ELECTRO_ALT_MISS,
	EV_ENERGY_ALT_MISS,
	EV_NECRO_ALT_MISS, 
	...
	EV_ROCK_ALT_MISS,
	EV_CHAOS_ALT_MISS,
	EV_NECROPOISON_ALT_MISS, 
	EV_NECROVOID_ALT_MISS,
	EV_NECROSMOG_ALT_MISS,
	EV_NECROMUD_ALT_MISS,
	EV_NECROCRYSTAL_ALT_MISS
} entity_event_t;
...
typedef enum {
	...
	MOD_UNKNOWN,
	MOD_SABER, 
	// Arma Glifica a Glifo del Suono 
	MOD_BRYAR,// Generic Pistols main shoots, bullets   
	MOD_BRYAR_ALT, // Generic Pistols alt shoots, bullets 
	MOD_BLASTER,// Rifle Shoot, bullets 
	MOD_BLASTER_ALT, // Rifle Alt Shoot, bullets
	MOD_DISRUPTOR,// Arco glifico degli Scout, Main Shoot
	MOD_SNIPER,// Arco Glifico degli Scout, Alt Shoots 
	MOD_BOWCASTER,// Crossbow Main shoot of ironguards 
	MOD_BOWCASTER_ALT,//Crossbow alt shoot of ironguard 
	MOD_REPEATER, // Repeater rifle main shoot generic, bullets 
	MOD_REPEATER_ALT,// Repeater Rifle Alt Shoot, bullets 
	MOD_DEMP2, // AOE Exotic weapon, main shoot 
	MOD_DEMP2_ALT, // AOE Exotic weapon, alt shoot  
	// Arma glifica a glifo della Pietra 
	MOD_FLECHETTE, // Carabine Main Shoot, bullet shrapnels  
	MOD_FLECHETTE_ALT, // Carabine Alt shoot, bullet shrapnels  
	MOD_ROCKET, // Rocket Launcher main Shoot  
	MOD_ROCKET_ALT, // Rocket Launcher Alt Shoot, seekers 

	MOD_CONC,//  Artillery Main Shoot  
	MOD_CONC_ALT,// Artillery Alt Shoot
	MOD_THERMAL, // Glyphic Grenadee, Main Time Shoot
	MOD_THERMAL_ALT, // Glyphyc Grenade, Alt Shoot
	MOD_DETPACK,// Glyphic Sysmic Quake Bomb, main shoot
	MOD_LASERTRIP,// Sonic Mine trap Glyph weapon
	MOD_LASERTRIP_ALT,// Sonic Mine Trap glyph weapon Proxy mines. 
	MOD_CANNON, // HandCannon of vampire hunters shoot 
	MOD_CANNON_ALT, //Handcannon of vampire Hunters alt shoots   
	MOD_BLOODGUN, // Prophetess guns main shoot
	MOD_BLOODGUN_ALT, // Prophetess guns alt shoot
	MOD_ALCHEMIC,// Alchemic cannon of Alchemists Main Shoots
	MOD_ALCHEMIC_ALT,// Alchemic cannon of Alchemists Alt Shoots 
	MOD_BOW,	// Bow shoots of arrows of vampire hunters
	MOD_BOW_ALT, // bow shoots of arrows of vampire hunters alt shoot
	MOD_EMPLACED, // Hylden glyphic cannon with green fire  
	
	// Worlds Attac Generic 
	MOD_MELEE, // Punches, physical dmg  
	MOD_SEEKER, // Seeker weapon 
	MOD_FORCE_GRIP, // Telekinesis grip 
	MOD_FORCE_LIGHTNING, //Energy Bolts attack from hands,  
	MOD_FORCE_DRAIN, // Vampiric blood gout and blood shower
	
// world / generic
	MOD_ELECTROCUTE, // Electrocuting 
	MOD_EXPLOSIVE, // Explosion damage 
	MOD_EXPLOSIVE_SPLASH,// Explosion AOE damage 
	MOD_KNOCKOUT,// knockback damage of swords 
	MOD_CRUSH,// Crush damage 
	MOD_IMPACT,// Damage of be hitted by something of pushed into something
	MOD_FALLING,// Falling damage 
	MOD_SUICIDE,// suicide damage 
	MOD_TRIGGER_HURT, 
	MOD_DARK, 
	MOD_LIGHT,
    MOD_FIRE,	
	MOD_AIR, 
	MOD_WATER, //Annegamento
	MOD_WATER2, 	
	MOD_EARTH,
	MOD_SOUND,
	MOD_SONIC, 
	...
	MOD_DECAL, 
	MOD_POISON,
    MOD_SLIME, // Slimer damage, acid damage , danno dei laghi acidi e della pioggia acida  
	MOD_GAS, // Poison Gas Damage 
	MOD_NECRO, 
	MOD_SPECTRAL, 
	MOD_SPIRIT, 
	MOD_HOLY, 
	MOD_LIFE, 
	// MIETITRICI DEI PILASTRI 
	MOD_BLOOD, 
	MOD_MIND,
	MOD_DIMENSION,
	MOD_CONFLICT, 
