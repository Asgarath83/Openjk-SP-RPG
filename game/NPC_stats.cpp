...
stringID_table_t FPTable[] =
{
	...
	ENUM2STRING(FP_HEALOTHER),
	ENUM2STRING(FP_WRACK),
	ENUM2STRING(FP_FORCEGLYPH),
	ENUM2STRING(FP_STONEGLYPH),
	ENUM2STRING(FP_SOUNDGLYPH),
	ENUM2STRING(FP_WATERGLYPH),
	ENUM2STRING(FP_FIREGLYPH),
	ENUM2STRING(FP_SUNGLYPH),
	ENUM2STRING(FP_WINDGLYPH),
	ENUM2STRING(FP_HOLYGLYPH),
	ENUM2STRING(FP_DARKGLYPH),
	ENUM2STRING(FP_NECROGLYPH),
	{ "",	-1 }
};
...
stringID_table_t WorldTable[] =
{
	// OLD STAR TREK ELITE FORCES RACES 
	ENUM2STRING(WORLD_NONE),
	ENUM2STRING(VORKAN),
	ENUM2STRING(NUBIKUS),
	ENUM2STRING(ZOLTAN),
	ENUM2STRING(SELVARUS),
	ENUM2STRING(DEMETRIUS),
	ENUM2STRING(KIRDUS),
	ENUM2STRING(KOROT), 
	ENUM2STRING(IDRUS), 
	ENUM2STRING(ICARUS), 
...
stringID_table_t LevelTable[] =
{
	// OLD STAR TREK ELITE FORCES RACES 
	ENUM2STRING(LEVEL_NONE),
	ENUM2STRING(LEVEL1), 
	ENUM2STRING(LEVEL2),
	ENUM2STRING(LEVEL3),
	ENUM2STRING(LEVEL4),
	...
	ENUM2STRING(LEVEL98),
	ENUM2STRING(LEVEL99),
	ENUM2STRING(LEVEL100),
	ENUM2STRING(LEVEL101),
	ENUM2STRING(LEVEL102),
	ENUM2STRING(LEVEL103),
	ENUM2STRING(LEVEL104),
	ENUM2STRING(LEVEL105),
	ENUM2STRING(LEVEL106), 
	ENUM2STRING(LEVEL107), 
	ENUM2STRING(LEVEL108), 
	ENUM2STRING(LEVEL109), 
	ENUM2STRING(LEVEL110), 
	ENUM2STRING(LEVEL111), 
	ENUM2STRING(LEVEL112), 
	ENUM2STRING(LEVEL113), 
	ENUM2STRING(LEVEL114),
	ENUM2STRING(LEVEL115),
	ENUM2STRING(LEVEL116),
	ENUM2STRING(LEVEL117),
	ENUM2STRING(LEVEL118),
	ENUM2STRING(LEVEL119),
	ENUM2STRING(LEVEL120),
	{ "",	-1 }
};

stringID_table_t ArmorTable[] =
{
	// OLD STAR TREK ELITE FORCES RACES 
	ENUM2STRING(ARMOR_NONE),
	ENUM2STRING(ARMOR1), // 100 ARMOR POINT  
	ENUM2STRING(ARMOR2), // 120 ARMOR POINT 
	ENUM2STRING(ARMOR3), // 150 ARMOR POINT 
	ENUM2STRING(ARMOR4), // 200 ARMOR POINT  
	ENUM2STRING(ARMOR5), // 250 ARMOR POINT 
	ENUM2STRING(ARMOR6), // 300 ARMOR POINT 
	ENUM2STRING(ARMOR7), // 350 ARMOR POINT 
	ENUM2STRING(ARMOR8), // 400 ARMOR POINT 
	ENUM2STRING(ARMOR9), // 450 ARMOR POINT 
	ENUM2STRING(ARMOR10), // 500 ARMOR POINT 
	ENUM2STRING(ARMOR11), // 550 ARMOR POINT  
	ENUM2STRING(ARMOR12), // 600 ARMOR POINT  
	ENUM2STRING(ARMOR13), // 650 ARMOR POINT  
	ENUM2STRING(ARMOR14), // 700 ARMOR POINT  
	ENUM2STRING(ARMOR15), // 750 ARMOR POINT  
	ENUM2STRING(ARMOR16), // 800 ARMOR POINT  
	ENUM2STRING(ARMOR17), // 850 ARMOR POINT  
	ENUM2STRING(ARMOR18), // 900 ARMOR POINT 
	ENUM2STRING(ARMOR19), // 950 ARMOR POINT 
	ENUM2STRING(ARMOR20), // 1000 ARMOR POINT 
	{ "",	-1 }
};
...
stringID_table_t ClassTable[] =
{
	...
	// LOK CLASS
	// Spectral Creature
	ENUM2STRING(CLASS_SLUAGH),// Like Rancor, but they not devour enemies. 				// hopefully this will never be used by an npc), just covering all bases
	ENUM2STRING(CLASS_REAPER),// Like spectral rockettrooper
	ENUM2STRING(CLASS_DREADNOUGHT), // Like spectral hazardtrooper),
	ENUM2STRING(CLASS_GHOST),		
	ENUM2STRING(CLASS_VAMPIRE_GHOST),
	// Humans
	ENUM2STRING(CLASS_HUNTER),
	ENUM2STRING(CLASS_SCOUT),			
	ENUM2STRING(CLASS_ALCHEMIST),
	ENUM2STRING(CLASS_PROPHET),
	ENUM2STRING(CLASS_DRUID),
	ENUM2STRING(CLASS_LYCAN),
	ENUM2STRING(CLASS_SARAFAN),				// droid
	ENUM2STRING(CLASS_WIZARD),
	ENUM2STRING(CLASS_ARCHER),
	ENUM2STRING(CLASS_WARRIOR),
	ENUM2STRING(CLASS_CENOBITA),
	// Evil Vampires
	ENUM2STRING(CLASS_MELC),
	ENUM2STRING(CLASS_SUMMONER),
	ENUM2STRING(CLASS_ZEPH),
	ENUM2STRING(CLASS_DECEIVER),		// droid 
	ENUM2STRING(CLASS_DUMAHIM),				
	ENUM2STRING(CLASS_RAHABIM),				
	ENUM2STRING(CLASS_TURELIM),
	// Generic vampire 
	ENUM2STRING(CLASS_VAMPIRE),			
	ENUM2STRING(CLASS_VAMPIRE_DEMON),
	// Alliance Vampires 
	ENUM2STRING(CLASS_KAIN),
	ENUM2STRING(CLASS_KAIN2),
	ENUM2STRING(CLASS_KAIN3),
	ENUM2STRING(CLASS_UMAH),
	ENUM2STRING(CLASS_ARIEL),
	ENUM2STRING(CLASS_VORADOR),
	ENUM2STRING(CLASS_JANOS),
	ENUM2STRING(CLASS_NECROMANCER),
	ENUM2STRING(CLASS_VAMPIRE_QUEEN),
	ENUM2STRING(CLASS_VAMPIRE_DARK),
	ENUM2STRING(CLASS_VAMPIRE_NECRO),
	ENUM2STRING(CLASS_VAMPIRE_NECRO2),
	ENUM2STRING(CLASS_VAMPIRE_FEAR),
	ENUM2STRING(CLASS_VAMPIRE_FEAR2),
	ENUM2STRING(CLASS_VAMPIRE_BLOOD),		// droid 
	ENUM2STRING(CLASS_VAMPIRE_SOUND),				
	ENUM2STRING(CLASS_VAMPIRE_LYCAN),				
	ENUM2STRING(CLASS_VAMPIRE_ELF),
	ENUM2STRING(CLASS_VAMPIRE_ELF2),
	ENUM2STRING(CLASS_VAMPIRE_ELF3),// FOR RAINBOW LION LEVEL 3 
	ENUM2STRING(CLASS_VAMPIRE_WATER),
	ENUM2STRING(CLASS_VAMPIRE_FROST),
	ENUM2STRING(CLASS_VAMPIRE_ARCHER),		// droid 
	ENUM2STRING(CLASS_HALFVAMPIRE),
	ENUM2STRING(CLASS_RAZIELHIM),
	ENUM2STRING(CLASS_VAMPIRE_BOUNTY),				
	ENUM2STRING(CLASS_VAMPIRE_ZOMBIE),
	ENUM2STRING(CLASS_VAMPIRE_SARAFAN), 
	ENUM2STRING(CLASS_WOLFFORM),
	ENUM2STRING(CLASS_WOLFKAIN),
	ENUM2STRING(CLASS_WOLFKAIN2),
	ENUM2STRING(CLASS_WOLFKAIN3),
	ENUM2STRING(CLASS_WOLFVORADOR),		// droid 
	ENUM2STRING(CLASS_WOLFJANOS),
	ENUM2STRING(CLASS_WOLFNECROMANCER),
	ENUM2STRING(CLASS_WOLFVAMPIRE_QUEEN),				
	ENUM2STRING(CLASS_WOLFVAMPIRE_FEAR),
	ENUM2STRING(CLASS_WOLFVAMPIRE_FEAR2),
	ENUM2STRING(CLASS_HELLWOLF),
	ENUM2STRING(CLASS_WOLFVAMPIRE_LYCAN),
	ENUM2STRING(CLASS_WOLFVAMPIRE_ELF),
	ENUM2STRING(CLASS_LIONVAMPIRE_ELF),
	ENUM2STRING(CLASS_LIONVAMPIRE_ELF2), // rainbow lion 
	ENUM2STRING(CLASS_WOLFHALFVAMPIRE),		// droid 
	ENUM2STRING(CLASS_ESKANDOR),
	ENUM2STRING(CLASS_BATFORM),	
	ENUM2STRING(CLASS_BATKAIN),
	ENUM2STRING(CLASS_BATKAIN2),
	ENUM2STRING(CLASS_BATKAIN3),
	ENUM2STRING(CLASS_BATVORADOR),		// droid 
	ENUM2STRING(CLASS_BATNECROMANCER),
	ENUM2STRING(CLASS_BATVAMPIRE_QUEEN),
	ENUM2STRING(CLASS_BATVAMPIRE_FROST),
	ENUM2STRING(CLASS_HELLBAT),
	ENUM2STRING(CLASS_BATVAMPIRE_FEAR),
	ENUM2STRING(CLASS_BATVAMPIRE_FEAR2),
	ENUM2STRING(CLASS_BATVAMPIRE_WATER),
	ENUM2STRING(CLASS_BATVAMPIRE_ELF),
	ENUM2STRING(CLASS_BATVAMPIRE_ELF2),
	ENUM2STRING(CLASS_BATVAMPIRE_ELF3),
// MIST FORM 
	ENUM2STRING(CLASS_MISTFORM),
// PERSONAL MIST FORM 
	ENUM2STRING(CLASS_MISTKAIN),
	ENUM2STRING(CLASS_MISTKAIN2),
	ENUM2STRING(CLASS_MISTKAIN3),
	ENUM2STRING(CLASS_MISTVORADOR),		// droid 
	ENUM2STRING(CLASS_MISTJANOS),
	ENUM2STRING(CLASS_MISTNECROMANCER),
	ENUM2STRING(CLASS_MISTVAMPIRE_QUEEN),				
	ENUM2STRING(CLASS_MISTVAMPIRE_DARK),
	ENUM2STRING(CLASS_MISTVAMPIRE_FEAR),
	ENUM2STRING(CLASS_MISTVAMPIRE_FEAR2),
	ENUM2STRING(CLASS_MISTVAMPIRE_BLOOD),
	ENUM2STRING(CLASS_MISTVAMPIRE_WATER),
	ENUM2STRING(CLASS_HELLMIST),
	ENUM2STRING(CLASS_MISTVAMPIRE_SARAFAN),
	ENUM2STRING(CLASS_MISTVAMPIRE_ELF),
	ENUM2STRING(CLASS_MISTVAMPIRE_ELF2),
	ENUM2STRING(CLASS_MISTVAMPIRE_ELF3),
	// Alliance Reavers 	
	ENUM2STRING(CLASS_REAVER),
	ENUM2STRING(CLASS_RAZIEL),				
	ENUM2STRING(CLASS_NECROREAVER),
	ENUM2STRING(CLASS_DARKREAVER),			
	ENUM2STRING(CLASS_TANKREAVER),
	ENUM2STRING(CLASS_LIGHTREAVER),	
	ENUM2STRING(CLASS_DRUIDREAVER),				
	ENUM2STRING(CLASS_ICEREAVER),			// droid
	ENUM2STRING(CLASS_SPIDERREAVER),		// droid
	ENUM2STRING(CLASS_SPIDERREAVER2),
	ENUM2STRING(CLASS_SPIDERREAVER3),
	ENUM2STRING(CLASS_FIREREAVER),
	ENUM2STRING(CLASS_AIRREAVER),
	ENUM2STRING(CLASS_MENTALIST),			// droid
	ENUM2STRING(CLASS_EARTHREAVER),
	// Hyldens
	ENUM2STRING(CLASS_HYLDEN),
	ENUM2STRING(CLASS_HYLDENLORD),
	// Demons
	ENUM2STRING(CLASS_DEMON_FIRE),			// droid
	ENUM2STRING(CLASS_DEMON_POISON),			// droid
	ENUM2STRING(CLASS_DEMON_BLADE),				// droid
	ENUM2STRING(CLASS_DEMON_ELECTRO),				// droid
	// Undeads 
	ENUM2STRING(CLASS_THRALL),
	ENUM2STRING(CLASS_POLTER),
	// Elementals 
	ENUM2STRING(CLASS_DARK),
	ENUM2STRING(CLASS_LIGHT),
	ENUM2STRING(CLASS_FIRE),
	ENUM2STRING(CLASS_WATER),			// droid
	ENUM2STRING(CLASS_CRYSTAL),
	ENUM2STRING(CLASS_AIR),
	ENUM2STRING(CLASS_EARTH),
	ENUM2STRING(CLASS_NECRO),
	ENUM2STRING(CLASS_HOLY),
	ENUM2STRING(CLASS_POISON),
	ENUM2STRING(CLASS_IVY),
	ENUM2STRING(CLASS_SONIC),
	// Animals 
	ENUM2STRING(CLASS_BIRD),
	ENUM2STRING(CLASS_BEAST),
	ENUM2STRING(CLASS_SHARK),
	// Elder God 
	ENUM2STRING(CLASS_TENTACLE),
	ENUM2STRING(CLASS_ELDERGOD),
	// GOLEM CLASSES 
	ENUM2STRING(CLASS_GOLEM_DARK),
	ENUM2STRING(CLASS_GOLEM_LIGHT),
	ENUM2STRING(CLASS_GOLEM_GOLD),
	ENUM2STRING(CLASS_GOLEM_FIRE),
	ENUM2STRING(CLASS_GOLEM_WATER),			// droid
	ENUM2STRING(CLASS_GOLEM_ICE),
	ENUM2STRING(CLASS_GOLEM_AIR),
	ENUM2STRING(CLASS_GOLEM_METAL),
	ENUM2STRING(CLASS_GOLEM),
	ENUM2STRING(CLASS_GOLEM_SONIC),
	ENUM2STRING(CLASS_GOLEM_HOLY),
	// HELLGOLEMS 
	ENUM2STRING(CLASS_HELLGOLEM),
	ENUM2STRING(CLASS_GOLEM_NECRO),
	ENUM2STRING(CLASS_GOLEM_SMOKE),
	ENUM2STRING(CLASS_GOLEM_VOID),
	ENUM2STRING(CLASS_GOLEM_POISON),
	ENUM2STRING(CLASS_GOLEM_LAVA),
	ENUM2STRING(CLASS_NAERYANMIST),
	ENUM2STRING(CLASS_NAERYANMIST2), 
	ENUM2STRING(CLASS_NAERYANMIST3), 
	// ASTROFANTASY CLASS 
	ENUM2STRING(CLASS_VESU),
	ENUM2STRING(CLASS_TORCH),
	ENUM2STRING(CLASS_PYRO),
	ENUM2STRING(CLASS_PYROFISH),
	ENUM2STRING(CLASS_KHROLEN),
	ENUM2STRING(CLASS_DAKTUR),
	ENUM2STRING(CLASS_CRALATOR),
	ENUM2STRING(CLASS_LADAQ),
	ENUM2STRING(CLASS_VEGETER),
	ENUM2STRING(CLASS_VEGRET),
	ENUM2STRING(CLASS_MONKER),
	ENUM2STRING(CLASS_APER),
	ENUM2STRING(CLASS_CRANION),
	ENUM2STRING(CLASS_ROBOPOC),
	ENUM2STRING(CLASS_SHAMOR),
	ENUM2STRING(CLASS_NARK),
	ENUM2STRING(CLASS_GELIOT),
	ENUM2STRING(CLASS_BEZ),
	ENUM2STRING(CLASS_FORLOK),
	ENUM2STRING(CLASS_ARLAAN),
	ENUM2STRING(CLASS_SONARI),
	ENUM2STRING(CLASS_KWARG),
	ENUM2STRING(CLASS_GORK),
	ENUM2STRING(CLASS_FAIR),
	ENUM2STRING(CLASS_OGRE),
	ENUM2STRING(CLASS_GUTUK),
	ENUM2STRING(CLASS_VARK),
	ENUM2STRING(CLASS_WARK),
	ENUM2STRING(CLASS_GOBLIN),
	ENUM2STRING(CLASS_CENTOPULOS),
	ENUM2STRING(CLASS_KOROTBEAST),
	ENUM2STRING(CLASS_RAGAN),
	ENUM2STRING(CLASS_IDRUSBEAST),
	ENUM2STRING(CLASS_POSUS),
	ENUM2STRING(CLASS_FALKOR),
	ENUM2STRING(CLASS_DRAGON),
	ENUM2STRING(CLASS_ICARUSBEAST),
	ENUM2STRING(CLASS_SFERX),
	ENUM2STRING(CLASS_SFEROID),
	ENUM2STRING(CLASS_WINGOID),
	ENUM2STRING(CLASS_ANTWER),
	ENUM2STRING(CLASS_SPELEOBEAST),
	ENUM2STRING(CLASS_SKEELDER),
	ENUM2STRING(CLASS_OVLON),
	ENUM2STRING(CLASS_NECROBEAST),
	ENUM2STRING(CLASS_NECROBIRD),
	ENUM2STRING(CLASS_DARKDRAGON),
	ENUM2STRING(CLASS_VOD),
	ENUM2STRING(CLASS_FIGHTER),
	ENUM2STRING(CLASS_CANNON),
	ENUM2STRING(CLASS_TANK),
	ENUM2STRING(CLASS_MANX),
	ENUM2STRING(CLASS_WALKER),
	ENUM2STRING(CLASS_SKIMMER),
	ENUM2STRING(CLASS_FYRON),
	ENUM2STRING(CLASS_NIUMUN),
	ENUM2STRING(CLASS_SPIDER),
	ENUM2STRING(CLASS_IVER),
	ENUM2STRING(CLASS_ASHAK),
	ENUM2STRING(CLASS_HOVERSTAR),
	ENUM2STRING(CLASS_TRANSFER),
	ENUM2STRING(CLASS_KOSMER),
	ENUM2STRING(CLASS_ANCLE),
	ENUM2STRING(CLASS_TRIDEB),
	ENUM2STRING(CLASS_EAGLE),
	ENUM2STRING(CLASS_BOWLER),
	ENUM2STRING(CLASS_STINGER),
	ENUM2STRING(CLASS_SKULL),
	ENUM2STRING(CLASS_VECTOR),
	ENUM2STRING(CLASS_DESTROYER),
	ENUM2STRING(CLASS_NIGHTCRAWLER),
	ENUM2STRING(CLASS_STATION),
	ENUM2STRING(CLASS_OLON),
	{ "",	-1 }
};

// MOD TABLE - MEANS OF DAMAGE 
...
// MOD TABLE - MEANS OF DAMAGE 
stringID_table_t Pistol_Table[] =
{
	ENUM2STRING(PISTOL_NONE),
		{ "",	-1 }
};


// RAYGUN TABLE - FOR RAYGUN EFFECTS OF GUN LIBRARIES 
stringID_table_t RayGunTable[] =
{
	ENUM2STRING(RAY_NONE),
	ENUM2STRING(RAY_CRIMSON),
	ENUM2STRING(RAY_RED),
	ENUM2STRING(RAY_ORANGE),
	ENUM2STRING(RAY_YELLOW), 
	ENUM2STRING(RAY_BROWN), 
	ENUM2STRING(RAY_GREEN),
	ENUM2STRING(RAY_BLUE), 
	ENUM2STRING(RAY_AZURE), 
	ENUM2STRING(RAY_CYAN), 
	ENUM2STRING(RAY_INDIGO),
	ENUM2STRING(RAY_PURPLE), 
	ENUM2STRING(RAY_PINK), 
	ENUM2STRING(RAY_WHITE), 
	ENUM2STRING(RAY_GREY), 
	ENUM2STRING(RAY_BLACK), 
	{ "",	-1 }
};

stringID_table_t ChargeGunTable[] =
{
	ENUM2STRING(CHARGE_NONE),
	// glow colors char shaders 
	ENUM2STRING(CHARGE_CRIMSON),
	ENUM2STRING(CHARGE_RED),
	ENUM2STRING(CHARGE_ORANGE),
	ENUM2STRING(CHARGE_YELLOW), 
	ENUM2STRING(CHARGE_BROWN), 
	ENUM2STRING(CHARGE_GREEN),
	ENUM2STRING(CHARGE_BLUE), 
	ENUM2STRING(CHARGE_AZURE), 
	ENUM2STRING(CHARGE_CYAN), 
	ENUM2STRING(CHARGE_INDIGO),
	ENUM2STRING(CHARGE_PURPLE), 
	ENUM2STRING(CHARGE_PINK), 
	ENUM2STRING(CHARGE_WHITE), 
	ENUM2STRING(CHARGE_GREY), 
	ENUM2STRING(CHARGE_BLACK), 
	{ "",	-1 }
};
...
//
#define MAX_NPC_DATA_SIZE (10 * 1024 * 1024) //0x100000 // original is 0x80000
...
saber_colors_t TranslateSaberColor( const char *name ) 
{
	...
	if ( !Q_stricmp( name, "whiteblue" ) ) 
	{
		return SABER_WHITEBLUE;
	}
	if ( !Q_stricmp( name, "brown" ) ) 
	{
		return SABER_BROWN;
	}
	if ( !Q_stricmp( name, "green2" ) ) 
	{
		return SABER_GREEN2;
	}
	...
	{
		return ((saber_colors_t)(Q_irand( SABER_RED, SABER_DARK )));
	}
	return SABER_BLUE;
}
...
void CG_NPC_Precache ( gentity_t *spawner )
{
	...
	while ( 1 ) 
	{
		...
		//////////////////// WEAPON BLASTER PISTOL VARIATION ////////////////

		
	if ( !Q_stricmp( token, "gun" ) ) 
		{
			if ( COM_ParseString( &p, &value ) ) 
			{
				continue;
			}
			char *GunName = G_NewString( value );
			gunData_t gun;
			WP_GunParseParms( GunName, &gun );
			if ( gun.Gun_Model && gun.Gun_Model[0] )
			{
				G_ModelIndex( gun.Gun_Model );
			}
			if ( gun.Gun_Skin && gun.Gun_Skin[0] )
			{
				gi.RE_RegisterSkin( gun.Gun_Skin );
				G_SkinIndex( gun.Gun_Skin );
			} 
		}
	...
	//===AI STATS=====================================================================
		...
		//		}
			...
			if ( !Q_stricmp( token, "health" ) ) 
			{
				...
				else if ( parsingPlayer ) // BREAK 100 LIMIT HEALTH? 
				{
					NPC->client->ps.stats[STAT_MAX_HEALTH] = NPC->client->pers.maxHealth = NPC->max_health = n;
					// DUSTY ADD 5 FOR MOMENT NOT WORKING! 
...
//===MISC===============================================================================
			...
			// DUSTY WANT TO DELET THIS BOH... ERROR CODE 
			if ( !parsingPlayer )
			{
				/*
			...
			if ( !Q_stricmp( token, "gun" ) ) 
			{
				...
				char *GunName = G_NewString( value );
				WP_GunParseParms( GunName, &NPC->client->gs.gun[0] );
				//if it requires a specific style, make sure we know how to use it
				continue;
			}
