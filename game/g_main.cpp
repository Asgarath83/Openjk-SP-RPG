...
extern  void WP_GunLoadParms( void ); 
...
void G_InitCvars( void ) {
	...
	g_gun = gi.cvar( "g_gun", "none", CVAR_ARCHIVE|CVAR_SAVEGAME|CVAR_NORESTART );	
	g_gun2 = gi.cvar( "g_gun2", "", CVAR_ARCHIVE|CVAR_SAVEGAME|CVAR_NORESTART );	
	...
	g_gunSwapPistols = gi.cvar( "g_gunSwapPistols", "0", CVAR_CHEAT );//lets you pick up pistols that are dropped
