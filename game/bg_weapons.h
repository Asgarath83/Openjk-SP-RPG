...
//NOT AGAIN AMMOQQQ	ammo_t*		ammoBase;			// The base ammo type that this weapon accepts
//NOT AGAIN AMMO 	ammo_t*		ammoDefault;		// The default ammo type (BUY AMMO) that is used
