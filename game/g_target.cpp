...
void set_mission_stats_cvars( void )
{
	...
	gi.cvar_set("ui_stats_healother", va("%d",client->sess.missionStats.forceUsed[FP_HEALOTHER]));
	gi.cvar_set("ui_stats_wrack", va("%d",client->sess.missionStats.forceUsed[FP_WRACK]));

	gi.cvar_set("ui_stats_forceglyph", va("%d",client->sess.missionStats.forceUsed[FP_FORCEGLYPH]));
	gi.cvar_set("ui_stats_soundglyph", va("%d",client->sess.missionStats.forceUsed[FP_SOUNDGLYPH]));
	gi.cvar_set("ui_stats_stoneglyph", va("%d",client->sess.missionStats.forceUsed[FP_STONEGLYPH]));
	gi.cvar_set("ui_stats_waterglyph", va("%d",client->sess.missionStats.forceUsed[FP_WATERGLYPH]));
	gi.cvar_set("ui_stats_fireglyph", va("%d",client->sess.missionStats.forceUsed[FP_FIREGLYPH]));
	gi.cvar_set("ui_stats_sunglyph", va("%d",client->sess.missionStats.forceUsed[FP_SUNGLYPH]));
	gi.cvar_set("ui_stats_windglyph", va("%d",client->sess.missionStats.forceUsed[FP_WINDGLYPH]));
	gi.cvar_set("ui_stats_holyglyph", va("%d",client->sess.missionStats.forceUsed[FP_WINDGLYPH]));
	gi.cvar_set("ui_stats_darkglyph", va("%d",client->sess.missionStats.forceUsed[FP_WINDGLYPH]));
	gi.cvar_set("ui_stats_necroglyph", va("%d",client->sess.missionStats.forceUsed[FP_WINDGLYPH]));
}
