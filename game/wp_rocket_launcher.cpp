...
//---------------------------------------------------------
{
	...
	if ( ent && ent->client && ent->client->NPC_class == CLASS_REBEL )
	{
		damage *= 1.5; // Elementali del Nebbia fanno 50% di danno in più!
	}
	else if ( ent && ent->client && ent->client->NPC_class == CLASS_ROCKETTROOPER )
	{
...
if ( alt_fire )
{	//NEBBIA
	if ( ent->client->NPC_class == CLASS_LIGHT || 
			...
			ent->client->NPC_class == CLASS_GOLEM_ICE 	)
	{
		{
			damage *= 1.5;
			G_PlayEffect( G_EffectIndex( "rocket2/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );
		}
	}// STORM
			...
			ent->client->NPC_class == CLASS_BOBAFETT )
	{
		{
			damage *= 2;
			G_PlayEffect( G_EffectIndex( "rocket3/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );
			...
			ent->client->NPC_class == CLASS_WEEQUAY )
	{
		{
			damage *= 1.5;
			G_PlayEffect( G_EffectIndex( "rocket4/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );

		}
	} // FLAY VAMPIRI ANZIANI FA PIU' DANNO 
	else if ( ent->client->NPC_class == CLASS_KYLE || ent->client->NPC_class == CLASS_FLIER2 ||
			ent->client->NPC_class == CLASS_LIZARD || ent->client->NPC_class == CLASS_KAIN ||
			...
			ent->client->NPC_class == CLASS_HYLDENLORD )			
	{
		{
			damage *= 3;
			G_PlayEffect( G_EffectIndex( "blackhole/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );

		}
	}
	// THRALL BREATH DMG 
	else if ( ent->client->NPC_class == CLASS_THRALL || 
			...
			ent->client->NPC_class == CLASS_PROPHET )
	{
		{
			damage *= 1.4;
			G_PlayEffect( G_EffectIndex( "thrallbreath/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );

		}
	}
	// THRALL BREATH BOSS DMG 
	else if ( ent->client->NPC_class == CLASS_MURJJ || ent->client->NPC_class == CLASS_GLIDER ||
			...
			ent->client->NPC_class == CLASS_TENTACLE )
	{
		{
			damage *= 4;
			G_PlayEffect( G_EffectIndex( "eldersphere/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );

		}
	}
	// TURELIM TK SHOT  
	else if ( ent->client->NPC_class == CLASS_GRAN ||
		ent->client->NPC_class == CLASS_TURELIM )
	{
		{
			damage *= 1.25;
			G_PlayEffect( G_EffectIndex( "tk/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );

		}
	}
	// TURELIM BOSS TK SHOT 
	...
	// ASTRAL CLASS GRAVITY ATK 
	else if ( ent->client->NPC_class == CLASS_LANDO )
	{
		{
			damage *= 2.5;
			G_PlayEffect( G_EffectIndex( "gravity/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );
			...
			ent->client->NPC_class == CLASS_SCOUT )
	{
		{
			damage *= 2;
			G_PlayEffect( G_EffectIndex( "sandstorm/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );

		}
	}
	// POISON FOG 
	else if ( ent->client->NPC_class == CLASS_MINEMONSTER || 
			...
			ent->client->NPC_class == CLASS_ALCHEMIST )
	{
		{
			damage *= 1.75;
			G_PlayEffect( G_EffectIndex( "poisonfog/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );
			...
			ent->client->NPC_class == CLASS_CENOBITA )
	{
		{
			damage *= 2.25;
			G_PlayEffect( G_EffectIndex( "spectralfog/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );
			...
			ent->client->NPC_class == CLASS_GOLEM_SMOKE  )
	{
		{
			damage *= 1;
			G_PlayEffect( G_EffectIndex( "rocket/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );
	...
	else if ( ent->client->NPC_class == CLASS_FIGHTER )
	{
		{
			damage *= 1;
			G_PlayEffect( G_EffectIndex( "rocket0/altmuzzle_flash" ), ent->client->renderInfo.handRPoint );
		}
	}
}
else 
{
			...
			ent->client->NPC_class == CLASS_GOLEM_ICE	)
	{
		{
			damage *= 1.5;
			G_PlayEffect( G_EffectIndex( "rocket2/muzzle_flash" ), ent->client->renderInfo.handRPoint );
		}
	}// STORM
	else if ( ent->client->NPC_class == CLASS_ROCKETTROOPER ||
			ent->client->NPC_class == CLASS_GOLEM_METAL || 
			...
			ent->client->NPC_class == CLASS_BOBAFETT )
	{
		{
			damage *= 2;
			G_PlayEffect( G_EffectIndex( "rocket3/muzzle_flash" ), ent->client->renderInfo.handRPoint );
			...
			ent->client->NPC_class == CLASS_WEEQUAY )
	{
		{
			damage *= 1.5;
			G_PlayEffect( G_EffectIndex( "rocket4/muzzle_flash" ), ent->client->renderInfo.handRPoint );
			...
			ent->client->NPC_class == CLASS_HYLDENLORD )
	{
		{
			damage *= 3;
			G_PlayEffect( G_EffectIndex( "blackhole/muzzle_flash" ), ent->client->renderInfo.handRPoint );
			...
			ent->client->NPC_class == CLASS_PROPHET )
	{
		{
			damage *= 1.4;
			G_PlayEffect( G_EffectIndex( "thrallbreath/muzzle_flash" ), ent->client->renderInfo.handRPoint );
			...
			ent->client->NPC_class == CLASS_TENTACLE )
	{
		{
			damage *= 4;
			G_PlayEffect( G_EffectIndex( "eldersphere/muzzle_flash" ), ent->client->renderInfo.handRPoint );

		}
	}
	// TURELIM TK SHOT  
	else if ( ent->client->NPC_class == CLASS_GRAN || ent->client->NPC_class == CLASS_TURELIM )
	{
		{
			damage *= 1.25;
			G_PlayEffect( G_EffectIndex( "tk/muzzle_flash" ), ent->client->renderInfo.handRPoint );
	...
	else if ( ent->client->NPC_class == CLASS_LANDO )
	{
		{
			damage *= 2.5;
			G_PlayEffect( G_EffectIndex( "gravity/muzzle_flash" ), ent->client->renderInfo.handRPoint );
			...
			ent->client->NPC_class == CLASS_SCOUT )
	{
		{
			damage *= 2;
			G_PlayEffect( G_EffectIndex( "sandstorm/muzzle_flash" ), ent->client->renderInfo.handRPoint );
			...
			ent->client->NPC_class == CLASS_ALCHEMIST )
	{
		{
			damage *= 1.75;
			G_PlayEffect( G_EffectIndex( "poisonfog/muzzle_flash" ), ent->client->renderInfo.handRPoint );
			...
			ent->client->NPC_class == CLASS_CENOBITA )
	{
		{
			damage *= 2.25;
			G_PlayEffect( G_EffectIndex( "spectralfog/muzzle_flash" ), ent->client->renderInfo.handRPoint );
			...
			ent->client->NPC_class == CLASS_GOLEM_SMOKE )
	{
		{
			damage *= 1;
			G_PlayEffect( G_EffectIndex( "rocket/muzzle_flash" ), ent->client->renderInfo.handRPoint );
	...
	else if ( ent->client->NPC_class == CLASS_FIGHTER )
	{
		{
			damage *= 1;
			G_PlayEffect( G_EffectIndex( "rocket0/muzzle_flash" ), ent->client->renderInfo.handRPoint );
		}
	}
}
