...
void MSG_WriteDeltaUsercmd( msg_t *msg, usercmd_t *from, usercmd_t *to ) {
	...
	MSG_WriteDelta( msg, from->weapon, to->weapon, 32 );// careful was 8! 
...
void MSG_ReadDeltaUsercmd( msg_t *msg, usercmd_t *from, usercmd_t *to ) {
	...
	to->weapon = MSG_ReadDelta( msg, from->weapon, 32); // WAS 8 ! QQQ
...
{ NETF(modelindex2), 8 },
{ NETF(modelindex3), 8 },
{ NETF(clientNum), GENTITYNUM_BITS }, // EDITED WAS 32 
{ NETF(frame), 16 },
{ NETF(solid), 24 },
...
{ PSF(clientNum), 32 }, // EDITED WAS 32! JKG is GENTITYNUM_BITS = 10 it should be sufficient, i guess... but we not want restrictions and have thousands entities into a server should be nice. 
{ PSF(weapon), 8 },// 256 SLOT? but i use just half... i guess are sufficient! was 32 originally was 5 . it setted as 32 Slots... but for 1024 weap the value shoule be 10. I PUT 6 for make the test of 64 weap...
{ PSF(weaponstate),	  4 },
...
// ADDED QQQ  
{ PSF(health), 32 }, // JKG was 10. 10 is 1024 HP. sufficient for jKA?
{ PSF(maxhealth), 32 }, // JKG was 10. you want to cap max health to 1024? 
};

//QQQ
//modelindex, -16 I prefear not touch that! 
//health, 10
//maxhealth, 10
/*userInt1, 1
userInt2, 1
